...
function ki(r, e, t, n) {
  for (let i = r.childCount, s = e.childCount; ; ) {
    ...
    if (o.content.size || l.content.size) {
      let c = ki(o.content, l.content, t - 1, n - 1);
      if (c)
        return c;
    }
    t -= a, n -= a;
...
let I = class Cn {
  ...
  */
  eq(e) {
    return this == e || this.type == e.type && At(this.attrs, e.attrs);
  }
  /**
...
class k {
  ...
  */
  insertAt(e, t) {
    let n = Si(this.content, e + this.openStart, t);
  ...
  */
  removeBetween(e, t) {
    return new k(xi(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function Mi(r, e, t, n) {
  ...
  if (i == e.index(n) && n < r.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && r.depth == n && e.depth == n) {
      ...
      return ve(o, l.cut(0, r.parentOffset).append(t.content).append(l.cut(e.parentOffset)));
    } else {
      let { start: o, end: l } = so(t, r);
      return ve(s, wi(r, o, l, e, n));
    }
  else return ve(s, Rt(r, e, n));
}
function Ci(r, e) {
...
function wi(r, e, t, n, i) {
  ...
  return st(null, r, i, l), s && o && e.index(i) == t.index(i) ? (Ci(s, o), Re(ve(s, wi(r, e, t, n, i + 1)), l)) : (s && Re(ve(s, Rt(r, e, i + 1)), l), st(e, t, i, l), o && Re(ve(o, Rt(t, n, i + 1)), l)), st(n, null, i, l), new b(l);
}
function Rt(r, e, t) {
  let n = [];
  if (st(null, r, t, n), r.depth > t) {
    let i = wn(r, e, t + 1);
    Re(ve(i, Rt(r, e, t + 1)), n);
  }
...
const lo = 12, ur = /* @__PURE__ */ new WeakMap();
class vt {
  /**
...
let ke = class On {
  ...
  */
  hasMarkup(e, t, n) {
    return this.type == e && At(this.attrs, t || e.defaultAttrs || ao) && I.sameSet(this.marks, n || I.none);
  }
  /**
  ...
  */
  copy(e = null) {
    return e == this.content ? this : new On(this.type, this.attrs, e, this.marks);
  }
  /**
  ...
  */
  mark(e) {
    return e == this.marks ? this : new On(this.type, this.attrs, this.content, e);
  }
  /**
  ...
  */
  replace(e, t, n) {
    return io(this.resolve(e), this.resolve(t), n);
  }
  /**
  ...
  */
  toString() {
    ...
    return this.content.size && (e += "(" + this.content.toStringInner() + ")"), Oi(this.marks, e);
  }
  /**
...
class Pt extends ke {
  ...
  */
  ...
  toString() {
    return this.type.spec.toDebugString ? this.type.spec.toDebugString(this) : Oi(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
function mo(r) {
  if (r.eat("(")) {
    ...
    let e = po(r, r.next).map((t) => (r.inline == null ? r.inline = t.isInline : r.inline != t.isInline && r.err("Mixing inline and block content"), { type: "name", value: t }));
...
let mr = class Ri {
  ...
  */
  constructor(e, t, n) {
    this.name = e, this.schema = t, this.spec = n, this.markSet = null, this.groups = n.group ? n.group.split(" ") : [], this.attrs = Ii(e, n.attrs), this.defaultAttrs = Ei(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(n.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : Di(this.attrs, e);
  }
  /**
  ...
  */
  create(e = null, t, n) {
    ...
    return new ke(this, this.computeAttrs(e), b.from(t), I.setFrom(n));
  }
  /**
  ...
  */
  createChecked(e = null, t, n) {
    return t = b.from(t), this.checkContent(t), new ke(this, this.computeAttrs(e), t, I.setFrom(n));
  }
  /**
  ...
  */
  createAndFill(e = null, t, n) {
    ...
    return s ? new ke(this, e, t.append(s), I.setFrom(n)) : null;
  }
  /**
  ...
  */
  checkAttrs(e) {
    Ai(this.attrs, e, "node", this.name);
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((s, o) => n[s] = new Ri(s, t, o));
...
class xo {
  constructor(e, t, n) {
    this.hasDefault = Object.prototype.hasOwnProperty.call(n, "default"), this.default = n.default, this.validate = typeof n.validate == "string" ? ko(e, t, n.validate) : n.validate;
  }
  get isRequired() {
...
class qt {
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new I(this, Di(this.attrs, e));
  }
  /**
  @internal
  */
  ...
  */
  checkAttrs(e) {
    Ai(this.attrs, e, "mark", this.name);
  }
  /**
...
class vi {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = V.from(e.nodes), t.marks = V.from(e.marks || {}), this.nodes = mr.compile(this.spec.nodes, this), this.marks = qt.compile(this.spec.marks, this);
    let n = /* @__PURE__ */ Object.create(null);
    for (let i in this.nodes) {
      ...
      s.markSet = l == "_" ? null : l ? gr(this, l.split(" ")) : l == "" || !s.inlineContent ? [] : null;
    }
    for (let i in this.marks) {
      let s = this.marks[i], o = s.spec.excludes;
      s.excluded = o == null ? [s] : o == "" ? [] : gr(this, o.split(" "));
    }
    this.nodeFromJSON = (i) => ke.fromJSON(this, i), this.markFromJSON = (i) => I.fromJSON(this, i), this.topNodeType = this.nodes[this.spec.topNode || "doc"], this.cached.wrappings = /* @__PURE__ */ Object.create(null);
  }
  /**
  ...
  */
  text(e, t) {
    ...
    return new Pt(n, n.defaultAttrs, e, I.setFrom(t));
  }
  /**
  ...
  */
  matchTag(e, t, n) {
    for (let i = n ? this.tags.indexOf(n) + 1 : 0; i < this.tags.length; i++) {
      let s = this.tags[i];
      if (Oo(e, s.tag) && (s.namespace === void 0 || e.namespaceURI == s.namespace) && (!s.context || t.matchesContext(s.context))) {
        if (s.getAttrs) {
          let o = s.getAttrs(e);
          if (o === !1)
            continue;
  ...
  */
  static schemaRules(e) {
    ...
    for (let i in e.marks) {
      ...
      s && s.forEach((o) => {
        n(o = kr(o)), o.mark || o.ignore || o.clearMark || (o.mark = i);
      });
    }
    for (let i in e.nodes) {
      let s = e.nodes[i].spec.parseDOM;
      s && s.forEach((o) => {
        n(o = kr(o)), o.node || o.ignore || o.mark || (o.node = i);
      });
    }
    return t;
  }
...
const Pi = {
  ...
  style: !0,
  title: !0
}, Bi = { ol: !0, ul: !0 }, ft = 1, Nn = 2, ot = 4;
function yr(r, e, t) {
  return e != null ? (e ? ft : 0) | (e === "full" ? Nn : 0) : r && r.whitespace == "pre" ? ft | Nn : t & ~ot;
}
class St {
  ...
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !Pi.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class br {
  constructor(e, t, n) {
    this.parser = e, this.options = t, this.isOpen = n, this.open = 0, this.localPreserveWS = !1;
    let i = t.topNode, s, o = yr(null, t.preserveWhitespace, 0) | (n ? ot : 0);
    i ? s = new St(i.type, i.attrs, I.none, !0, t.topMatch || i.type.contentMatch, o) : n ? s = new St(null, null, I.none, !0, null, o) : s = new St(e.schema.topNodeType, null, I.none, !0, null, o), this.nodes = [s], this.find = t.findPositions, this.needsBlock = !1;
  }
  get top() {
  ...
  addTextNode(e, t) {
    let n = e.nodeValue, i = this.top, s = i.options & Nn ? "full" : this.localPreserveWS || (i.options & ft) > 0, { schema: o } = this.parser;
...
`);
  ...
  addElement(e, t, n) {
    ...
    Bi.hasOwnProperty(o) && this.parser.normalizeLists && wo(e);
...
`), t);
  ...
  enterInner(e, t, n, i = !1, s) {
    ...
    let l = yr(e, s, o.options);
    o.options & ot && o.content.length == 0 && (l |= ot);
    let a = I.none;
    return n = n.filter((c) => (o.type ? o.type.allowsMarkType(c.type) : xr(c.type, e)) ? (a = c.addToSet(a), !1) : !0), this.nodes.push(new St(e, t, a, i, null, l)), this.open++, n;
  }
...
function wo(r) {
  for (let e = r.firstChild, t = null; e; e = e.nextSibling) {
    ...
    n && Bi.hasOwnProperty(n) && t ? (t.appendChild(e), e = t) : n == "li" ? t = e : n && (t = null);
  }
}
function Oo(r, e) {
...
class $e {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: n, contentDOM: i } = Tt(on(t), this.nodes[e.type.name](e), null, e.attrs);
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, t, n = {}) {
    ...
    return i && Tt(on(n), i(e, t), null, e.attrs);
  }
...
function No(r) {
  let e = Mr.get(r);
  return e === void 0 && Mr.set(r, e = To(r)), e;
}
function To(r) {
  let e = null;
  function t(n) {
...
function Tt(r, e, t, n) {
  ...
  for (let d = f; d < e.length; d++) {
    ...
    if (u === 0) {
      ...
      let { dom: h, contentDOM: p } = Tt(r, u, t, n);
...
const zi = 65535, Fi = Math.pow(2, 16);
function Eo(r, e) {
  return r + e * Fi;
}
function Cr(r) {
...
class Tn {
  ...
  */
  get deletedBefore() {
    return (this.delInfo & (Vi | Et)) > 0;
  }
  /**
  True when the token after the mapped position was deleted.
  */
  get deletedAfter() {
    return (this.delInfo & (Li | Et)) > 0;
  }
  /**
  ...
  _map(e, t, n) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= d) {
        ...
        if (n)
          return h;
        let p = e == (t < 0 ? a : d) ? null : Eo(l / 3, e - a), m = e == a ? Li : e == d ? Vi : Et;
        return (t < 0 ? e != a : e != d) && (m |= $i), new Tn(h, m, p);
      }
      i += f - c;
    }
    return n ? e + i : new Tn(e + i, 0, null);
  }
  /**
  @internal
  */
  touches(e, t) {
    let n = 0, i = Cr(t), s = this.inverted ? 2 : 1, o = this.inverted ? 1 : 2;
    for (let l = 0; l < this.ranges.length; l += 3) {
...
class B extends q {
  ...
  */
  ...
  apply(e) {
    return this.structure && En(e, this.from, this.to) ? R.fail("Structure replace would overwrite content") : R.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  map(e) {
    let t = e.mapResult(this.from, 1), n = e.mapResult(this.to, -1);
    return t.deletedAcross && n.deletedAcross ? null : new B(t.pos, Math.max(t.pos, n.pos), this.slice, this.structure);
  }
  merge(e) {
...
class z extends q {
  ...
  */
  ...
  apply(e) {
    if (this.structure && (En(e, this.from, this.gapFrom) || En(e, this.gapTo, this.to)))
...
function Ao(r, e, t, n) {
  ...
  r.doc.nodesBetween(e, t, (a, c, f) => {
    ...
    if (!n.isInSet(d) && f.type.allowsMarkType(n.type)) {
      ...
      l && l.to == u ? l.to = h : s.push(l = new ge(u, h, n));
    }
...
function vo(r, e, t) {
  ...
  r.step(new z(a, c, o, l, new k(f.append(u), d, h), f.size - d, !0));
}
function Kn(r, e, t = null, n = r) {
  let i = Po(r, e), s = i && Bo(n, e);
...
function Fo(r, e, t, n, i) {
  ...
  r.doc.nodesBetween(e, t, (o, l) => {
    ...
    if (o.isTextblock && !o.hasMarkup(n, a) && Vo(r.doc, r.mapping.slice(s).map(l), n)) {
      let c = null;
      if (n.schema.linebreakReplacement) {
        let h = n.whitespace == "pre", p = !!n.contentMatch.matchType(n.schema.linebreakReplacement);
        h && !p ? c = !1 : !h && p && (c = !0);
      }
      c === !1 && ji(r, o, l, s), qn(r, r.mapping.slice(s).map(l, 1), n, void 0, c === null);
      let f = r.mapping.slice(s), d = f.map(l, 1), u = f.map(l + o.nodeSize, 1);
      return r.step(new z(d, u, d + 1, u - 1, new k(b.from(n.create(a, null, o.marks)), 0, 0), 1, !0)), c === !0 && Wi(r, o, l, s), !1;
    }
  });
}
function Wi(r, e, t, n) {
...
function $o(r, e, t = 1, n) {
  ...
  r.step(new B(e, e, new k(s.append(o), t, t), !0));
}
function Oe(r, e) {
  let t = r.resolve(e), n = t.index();
  return Ji(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(n, n + 1);
}
function Wo(r, e) {
...
function Ji(r, e) {
  return !!(r && e && !r.isLeaf && Wo(r, e));
}
function Kt(r, e, t = -1) {
  let n = r.resolve(e);
  for (let i = n.depth; ; i--) {
    let s, o, l = n.index(i);
    if (i == n.depth ? (s = n.nodeBefore, o = n.nodeAfter) : t > 0 ? (s = n.node(i + 1), l++, o = n.node(i).maybeChild(l)) : (s = n.node(i).maybeChild(l - 1), o = n.node(i + 1)), s && !s.isTextblock && Ji(s, o) && n.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function jo(r, e, t) {
  ...
  if (r.step(new B(c, a.map(e + t, -1), k.empty, !0)), n === !0) {
    ...
    Wi(r, f.node(), f.before(), r.steps.length);
  }
  return r;
}
function Jo(r, e, t) {
...
function Ht(r, e, t = e, n = k.empty) {
  if (e == t && !n.size)
    return null;
  let i = r.resolve(e), s = r.resolve(t);
  return qi(i, s, n) ? new B(e, t, n) : new Ko(i, s, n).fit();
}
function qi(r, e, t) {
...
class Ko {
  ...
  fit() {
    ...
    let a = new k(s, o, l);
    return e > -1 ? new z(n.pos, e, this.$to.pos, this.$to.end(), a, t) : a.size || n.pos != this.$to.pos ? new B(n.pos, i.pos, a) : null;
  }
  ...
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let i, s = null;
        n ? (s = an(this.unplaced.content, n - 1).firstChild, i = s.content) : i = this.unplaced.content;
        let o = i.firstChild;
  ...
  openMore() {
    let { content: e, openStart: t, openEnd: n } = this.unplaced, i = an(e, t);
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: i, wrap: s }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!g)
        break;
      c++, (c > 1 || a == 0 || m.content.size) && (d = g, f.push(Ki(m.mark(u.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
  ...
  mustMoveInline() {
    ...
    if (!e.type.isTextblock || !cn(this.$to, this.$to.depth, e.type, e.match, !1) || this.$to.depth == this.depth && (t = this.findCloseLevel(this.$to)) && t.depth == this.depth)
      return -1;
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      let { match: n, type: i } = this.frontier[t], s = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), o = cn(e, t, i, n, s);
      if (o) {
        for (let l = t - 1; l >= 0; l--) {
          let { match: a, type: c } = this.frontier[l], f = cn(e, l, c, a, !0);
          if (!f || f.childCount)
            continue e;
        }
...
function Ki(r, e, t) {
  if (e <= 0)
    return r;
  let n = r.content;
  return e > 1 && (n = n.replaceChild(0, Ki(n.firstChild, e - 1, n.childCount == 1 ? t - 1 : 0))), e > 0 && (n = r.type.contentMatch.fillBefore(n).append(n), t <= 0 && (n = n.append(r.type.contentMatch.matchFragment(n).fillBefore(b.empty, !0)))), r.copy(n);
}
function cn(r, e, t, n, i) {
  ...
  return l && !Ho(t, s.content, o) ? l : null;
}
function Ho(r, e, t) {
    ...
    if (p)
      for (let m = 0; m < o.length; m++) {
        ...
        if (M.canReplaceWith(C, C, p.type, p.marks))
          return r.replace(i.before(g), y ? s.after(g) : t, new k(Hi(n.content, 0, n.openStart, h), h, n.openEnd));
      }
  }
...
function Hi(r, e, t, n, i) {
  if (e < t) {
    let s = r.firstChild;
    r = r.replaceChild(0, s.copy(Hi(s.content, e + 1, t, n, s)));
  }
  if (e > n) {
...
function Go(r, e, t, n) {
  if (!n.isInline && e == t && r.doc.resolve(e).parent.content.size) {
    let i = Jo(r.doc, e, n.type);
    i != null && (e = t = i);
  }
  r.replaceRange(e, t, new k(b.from(n), 0, 0));
}
function Yo(r, e, t) {
  let n = r.doc.resolve(e), i = r.doc.resolve(t), s = Ui(n, i);
  for (let o = 0; o < s.length; o++) {
...
class T {
  ...
  */
  constructor(e, t, n) {
    this.$anchor = e, this.$head = t, this.ranges = n || [new Xo(e.min(t), e.max(t))];
  }
  /**
  ...
  */
  replace(e, t = k.empty) {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      e.replaceRange(f.map(a.pos), f.map(c.pos), l ? k.empty : t), l == 0 && Tr(e, s, (n ? n.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  replaceWith(e, t) {
    ...
    for (let s = 0; s < i.length; s++) {
      ...
      s ? e.deleteRange(c, f) : (e.replaceRangeWith(c, f, t), Tr(e, n, t.isInline ? -1 : 1));
    }
  }
  /**
...
let Or = !1;
function Nr(r) {
  !Or && !r.parent.inlineContent && (Or = !0, console.warn("TextSelection endpoint not pointing into a node with inline content (" + r.parent.type.name + ")"));
}
class N extends T {
  /**
...
class Zo extends _i {
  ...
  */
  setSelection(e) {
    ...
    return this.curSelection = e, this.curSelectionFor = this.steps.length, this.updated = (this.updated | Er) & ~Mt, this.storedMarks = null, this;
  }
  /**
  Whether the selection was explicitly updated by this transaction.
  */
  get selectionSet() {
    return (this.updated & Er) > 0;
  }
  /**
  Set the current stored marks.
  */
  setStoredMarks(e) {
    return this.storedMarks = e, this.updated |= Mt, this;
  }
  /**
  ...
  */
  get storedMarksSet() {
    return (this.updated & Mt) > 0;
  }
  /**
  @internal
  */
  addStep(e, t) {
    super.addStep(e, t), this.updated = this.updated & ~Mt, this.storedMarks = null;
  }
  /**
  ...
  */
  insertText(e, t, n) {
      ...
      return e ? this.replaceSelectionWith(i.text(e), !0) : this.deleteSelection();
    {
      ...
      return this.replaceRangeWith(t, n, i.text(e, s)), this.selection.empty || this.setSelection(T.near(this.selection.$to)), this;
    }
  }
  /**
...
class He {
  ...
  */
  static create(e) {
    let t = new dn(e.doc ? e.doc.type.schema : e.schema, e.plugins), n = new He(t);
  ...
  */
  reconfigure(e) {
    let t = new dn(this.schema, e.plugins), n = t.fields, i = new He(t);
  ...
  */
  static fromJSON(e, t, n) {
    ...
    let i = new dn(e.schema, e.plugins), s = new He(i);
    return i.fields.forEach((o) => {
      if (o.name == "doc")
        s.doc = ke.fromJSON(e.schema, t.doc);
...
function Gi(r, e, t) {
  for (let n in r) {
    let i = r[n];
    i instanceof Function ? i = i.bind(e) : n == "handleDOMEvents" && (i = Gi(i, e, {})), t[n] = i;
  }
  return t;
}
class oe {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && Gi(e.props, this, this.props), this.key = e.key ? e.key.key : Yi("plugin");
  }
  /**
...
function Ir(r, e, t, n, i) {
  for (var s; ; ) {
    ...
    if (e == (i < 0 ? 0 : Q(r))) {
      let o = r.parentNode;
      if (!o || o.nodeType != 1 || yt(r) || nl.test(r.nodeName) || r.contentEditable == "false")
        return !1;
      e = L(r) + (i < 0 ? 0 : 1), r = o;
...
const ie = typeof navigator < "u" ? navigator : null, Rr = typeof document < "u" ? document : null, Ne = ie && ie.userAgent || "", An = /Edge\/(\d+)/.exec(Ne), Xi = /MSIE \d/.exec(Ne), In = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Ne), _ = !!(Xi || In || An), Se = Xi ? document.documentMode : In ? +In[1] : An ? +An[1] : 0, Z = !_ && /gecko\/(\d+)/i.test(Ne);
Z && +(/Firefox\/(\d+)/.exec(Ne) || [0, 0])[1];
const Rn = !_ && /Chrome\/(\d+)/.exec(Ne), J = !!Rn, Qi = Rn ? +Rn[1] : 0, K = !_ && !!ie && /Apple Computer/.test(ie.vendor), Qe = K && (/Mobile\/\w+/.test(Ne) || !!ie && ie.maxTouchPoints > 2), X = Qe || (ie ? /Mac/.test(ie.platform) : !1), al = ie ? /Win/.test(ie.platform) : !1, ce = /Android \d/.test(Ne), bt = !!Rr && "webkitFontSmoothing" in Rr.documentElement.style, cl = bt ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function fl(r) {
...
function vr(r, e, t) {
  ...
  for (let o = t || r.dom; o; ) {
    ...
    let l = o, a = l == s.body, c = a ? fl(s) : dl(l), f = 0, d = 0;
...
function ul(r) {
  ...
  return { refDOM: n, refTop: i, stack: Zi(r.dom) };
}
function Zi(r) {
...
function hl({ refDOM: r, refTop: e, stack: t }) {
...
function ts(r, e) {
  ...
  return !t && a && (t = a, i = c, n = 0), t && t.nodeType == 3 ? ml(t, i) : !t || n && t.nodeType == 1 ? { node: r, offset: s } : ts(t, i);
}
function ml(r, e) {
...
function yl(r, e, t) {
  let { node: n, offset: i } = ts(e, t), s = -1;
...
function kl(r, e) {
  let t = r.dom.ownerDocument, n, i = 0, s = ll(t, e.left, e.top);
  s && ({ node: n, offset: i } = s);
  ...
  if (o = gl(o, e), n) {
    if (Z && n.nodeType == 1 && (i = Math.min(i, n.childNodes.length), i < n.childNodes.length)) {
      let f = n.childNodes[i], d;
      f.nodeName == "IMG" && (d = f.getBoundingClientRect()).right <= e.left && d.bottom > e.top && i++;
    }
    let c;
    bt && i && n.nodeType == 1 && (c = n.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, n == r.dom && i == n.childNodes.length - 1 && n.lastChild.nodeType == 1 && e.top > n.lastChild.getBoundingClientRect().bottom ? l = r.state.doc.content.size : (i == 0 || n.nodeType != 1 || n.childNodes[i - 1].nodeName != "BR") && (l = bl(r, n, i, e));
  }
  l == null && (l = yl(r, o, e));
...
function he(r, e) {
  ...
  return Array.prototype.find.call(t, Pr) || r.getBoundingClientRect();
}
const xl = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function rs(r, e, t) {
  let { node: n, offset: i, atom: s } = r.docView.domFromPos(e, t < 0 ? -1 : 1), o = bt || Z;
  if (n.nodeType == 3)
    if (o && (xl.test(n.nodeValue) || (t < 0 ? !i : i == n.nodeValue.length))) {
      let a = he(ae(n, i, i), t);
      if (Z && i && /\s/.test(n.nodeValue[i - 1]) && i < n.nodeValue.length) {
      ...
      return t < 0 && !i ? (c++, f = -1) : t >= 0 && i == n.nodeValue.length ? (a--, f = 1) : t < 0 ? a-- : c++, tt(he(ae(n, a, c), f), f < 0);
    }
  if (!r.state.doc.resolve(e - (s || 0)).parent.inlineContent) {
    if (s == null && i && (t < 0 || i == Q(n))) {
      let a = n.childNodes[i - 1];
      if (a.nodeType == 1)
        return hn(a.getBoundingClientRect(), !1);
    }
    if (s == null && i < Q(n)) {
      let a = n.childNodes[i];
      if (a.nodeType == 1)
        return hn(a.getBoundingClientRect(), !0);
    }
  ...
  return tt(he(n.nodeType == 3 ? ae(n) : n, -t), t >= 0);
}
function tt(r, e) {
  if (r.width == 0)
    return r;
...
function Cl(r, e, t) {
  ...
  return l ? !Ml.test(n.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? s : o : is(r, e, () => {
...
let Br = null, zr = null, Fr = !1;
function wl(r, e, t) {
  return Br == e && zr == t ? Fr : (Br = e, zr = t, Fr = t == "up" || t == "down" ? Sl(r, e, t) : Cl(r, e, t));
}
const ee = 0, Vr = 1, Ae = 2, se = 3;
class kt {
  constructor(e, t, n, i) {
  ...
  domFromPos(e, t) {
    ...
    for (let s; n && !(s = this.children[n - 1]).size && s instanceof ss && s.side >= 0; n--)
      ;
    if (t <= 0) {
      let s, o = !0;
...
`), d && p == h.nodeValue.length)
    ...
    if (Z && f.focusNode && f.focusNode != a.node && f.focusNode.nodeType == 1) {
      let h = f.focusNode.childNodes[f.focusOffset];
      h && h.contentEditable == "false" && (i = !0);
    }
    if (!(i || d && K) && Ve(l.node, l.offset, f.anchorNode, f.anchorOffset) && Ve(a.node, a.offset, f.focusNode, f.focusOffset))
      return;
    let u = !1;
    if ((c.extend || e == t) && !(d && Z)) {
  ...
  markDirty(e, t) {
    for (let n = 0, i = 0; i < this.children.length; i++) {
      ...
      if (n == o ? e <= o && t >= n : e < o && t > n) {
        ...
        if (e >= l && t <= a) {
          this.dirty = e == n || t == o ? Ae : Vr, e == l && t == a && (s.contentLost || s.dom.parentNode != this.contentDOM) ? s.dirty = se : s.markDirty(e - l, t - l);
          return;
        } else
...
class Me extends kt {
  ...
  static create(e, t, n, i, s, o) {
    ...
    let u = f;
    return f = fs(f, n, t), c ? a = new Nl(e, t, n, i, f, d || null, u, c, s, o + 1) : t.isText ? new Gt(e, t, n, i, f, u, s) : new Me(e, t, n, i, f, d || null, u, s, o + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, n) {
    return this.dirty == ee && e.eq(this.node) && zt(t, this.outerDeco) && n.eq(this.innerDeco);
  }
  get size() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let n = this.node.inlineContent, i = t, s = e.composing ? this.localCompositionInfo(e, t) : null, o = s && s.pos > -1 ? s : null, l = s && s.pos < 0, a = new El(this, o && o.node, e);
    Il(this.node, this.innerDeco, (c, f, d) => {
    ...
    }), a.syncToMarks([], n, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == Ae) && (o && this.protectLocalComposition(e, o), as(this.contentDOM, this.children, e), Qe && Rl(this.dom));
  }
  localCompositionInfo(e, t) {
    ...
    if (this.node.inlineContent) {
      let o = s.nodeValue, l = vl(this.node.content, o, n - t, i - t);
  ...
  updateOuterDeco(e) {
    ...
    this.dom = cs(this.dom, this.nodeDOM, vn(this.outerDeco, this.node, t), vn(e, this.node, t)), this.dom != n && (n.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
class Gt extends Me {
  ...
  slice(e, t, n) {
    ...
    return new Gt(this.parent, i, this.outerDeco, this.innerDeco, s, s, n);
  }
  markDirty(e, t) {
...
function vn(r, e, t) {
  ...
  for (let s = 0; s < r.length; s++) {
    ...
    if (o) {
      ...
      for (let l in o) {
        let a = o[l];
        a != null && (t && i.length == 1 && i.push(n = new lt(e.isInline ? "span" : "div")), l == "class" ? n.class = (n.class ? n.class + " " : "") + a : l == "style" ? n.style = (n.style ? n.style + ";" : "") + a : l != "nodeName" && (n[l] = a));
      }
    }
  }
  return i;
...
function fs(r, e, t) {
  return cs(r, r, Ie, vn(e, t, r.nodeType != 1));
}
function zt(r, e) {
  if (r.length != e.length)
    return !1;
...
class El {
  constructor(e, t, n) {
    this.lock = t, this.view = n, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = Dl(e.node.content, e);
  }
  ...
  syncToMarks(e, t, n) {
    ...
    for (; i < o && (i == s - 1 ? this.top : this.stack[i + 1 << 1]).matchesMark(e[i]) && e[i].type.spec.spanning !== !1; )
      i++;
    for (; i < s; )
      this.destroyRest(), this.top.dirty = ee, this.index = this.stack.pop(), this.top = this.stack.pop(), s--;
    for (; s < e.length; ) {
  ...
  updateNextNode(e, t, n, i, s, o) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Me) {
        ...
        if (c != null && c != s)
          return !1;
        let f = a.dom, d, u = this.isLocked(f) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != se && zt(t, a.outerDeco));
  ...
  recreateWrapper(e, t, n, i, s, o) {
    if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content) || !zt(n, e.outerDeco) || !i.eq(e.innerDeco))
      return null;
...
function _n(r, e = null) {
  ...
  if (_t(t)) {
    for (a = o; i && !i.node; )
      i = i.parent;
    let d = i.node;
    if (i && d.isAtom && S.isSelectable(d) && i.parent && !(d.isInline && sl(t.focusNode, t.focusOffset, i.dom))) {
      let u = i.posBefore;
...
function ds(r) {
  return r.editable ? r.hasFocus() : hs(r) && document.activeElement && document.activeElement.contains(r.dom);
}
function ue(r, e = !1) {
  ...
  if (us(r, t), !!ds(r)) {
    ...
    if (r.domObserver.disconnectSelection(), r.cursorWrapper)
      ...
      Wr && !(t instanceof N) && (t.$from.parent.inlineContent || (s = jr(r, t.from)), !t.empty && !t.$from.parent.inlineContent && (o = jr(r, t.to))), r.docView.setSelection(n, i, r, e), Wr && (s && Jr(s), o && Jr(o)), t.visible ? r.dom.classList.remove("ProseMirror-hideselection") : (r.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && Pl(r));
    }
...
function Bl(r) {
  ...
  n ? e.collapse(t.parentNode, L(t) + 1) : e.collapse(t, 0), !n && !r.state.selection.visible && _ && Se <= 11 && (t.disabled = !0, t.disabled = !1);
}
function us(r, e) {
  if (e instanceof S) {
    let t = r.docView.descAt(e.from);
    t != r.lastSelectedViewDesc && (qr(r), t && t.selectNode(), r.lastSelectedViewDesc = t);
  } else
    qr(r);
}
function qr(r) {
...
function Kr(r) {
  return r.editable && !r.hasFocus() ? !1 : hs(r);
}
function hs(r) {
  ...
  if (n instanceof N)
    if (t.indexOf("s") > -1) {
      ...
      if (r.endOfTextblock(e > 0 ? "forward" : "backward")) {
        ...
        return s.isAtom || (o = r.docView.descAt(l)) && !o.contentDOM ? S.isSelectable(s) ? pe(r, new S(e < 0 ? r.state.doc.resolve(i.pos - s.nodeSize) : i)) : bt ? pe(r, new N(r.state.doc.resolve(e < 0 ? l : l + s.nodeSize))) : !1 : !1;
      }
    } else return !1;
  else {
...
function Fl(r) {
  ...
  if (!t)
    return;
  let i, s, o = !1;
  for (Z && t.nodeType == 1 && n < Ft(t) && at(t.childNodes[n], -1) && (o = !0); ; )
    if (n > 0) {
      if (t.nodeType != 1)
        break;
      {
...
function zn(r, e, t) {
  if (e.nodeType != 3) {
    let s, o;
    (o = Ll(e, t)) ? (e = o, t = 0) : (s = $l(e, t)) && (e = s, t = s.nodeValue.length);
  }
...
function Wl(r) {
  ...
  if (e && e.nodeType == 1 && t == 0 && e.firstChild && e.firstChild.contentEditable == "false") {
    let n = e.firstChild;
    Yr(r, n, "true"), setTimeout(() => Yr(r, n, "false"), 20);
  }
  return !1;
}
function jl(r) {
...
function Jl(r, e) {
  ...
  if (t == 8 || X && t == 72 && n == "c")
    return Gr(r, -1) || Je(r, -1);
  if (t == 46 && !e.shiftKey || X && t == 68 && n == "c")
    return Gr(r, 1) || Je(r, 1);
  if (t == 13 || t == 27)
    return !0;
  if (t == 37 || X && t == 66 && n == "c") {
    let i = t == 37 ? Ur(r, r.state.selection.from) == "ltr" ? -1 : 1 : -1;
    return Hr(r, i, n) || Je(r, i);
  } else if (t == 39 || X && t == 70 && n == "c") {
    let i = t == 39 ? Ur(r, r.state.selection.from) == "ltr" ? 1 : -1 : 1;
    return Hr(r, i, n) || Je(r, i);
  } else {
    if (t == 38 || X && t == 80 && n == "c")
      return _r(r, -1, n) || Je(r, -1);
    if (t == 40 || X && t == 78 && n == "c")
      return Wl(r) || _r(r, 1, n) || Je(r, 1);
...
function Yn(r, e) {
  ...
  let o = r.someProp("clipboardSerializer") || $e.fromSchema(r.state.schema), l = xs(), a = l.createElement("div");
...
`))), 0, 0), r.someProp("transformPasted", (u) => {
  ...
  if (l || (l = (r.someProp("clipboardParser") || r.someProp("domParser") || xe.fromSchema(r.state.schema)).parseSlice(o, {
    preserveWhitespace: !!(a || f),
    context: i,
    ruleFromNode(u) {
      return u.nodeName == "BR" && !u.nextSibling && u.parentNode && !ql.test(u.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), f)
    l = Gl(Xr(l, +f[1], +f[2]), f[4]);
  else if (l = k.maxOpen(Kl(l.content, i), !0), l.openStart || l.openEnd) {
    let d = 0, u = 0;
  ...
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (r.forEach((l) => {
      ...
      if (c = o.length && s.length && ys(a, s, l, o[o.length - 1], 0))
        ...
        o.length && (o[o.length - 1] = bs(o[o.length - 1], s.length));
        let f = gs(l, a);
...
function ys(r, e, t, n, i) {
  if (i < r.length && i < e.length && r[i] == e[i]) {
    let s = ys(r, e, t, n.lastChild, i + 1);
    if (s)
    ...
    if (n.contentMatchAt(n.childCount).matchType(i == r.length - 1 ? t.type : r[i + 1]))
      return n.copy(n.content.append(b.from(gs(t, r, i + 1))));
  }
}
function bs(r, e) {
  if (e == 0)
    return r;
  let t = r.content.replaceChild(r.childCount - 1, bs(r.lastChild, e - 1)), n = r.contentMatchAt(r.childCount).fillBefore(b.empty, !0);
  return r.copy(t.append(n));
}
function Fn(r, e, t, n, i, s) {
  let o = e < 0 ? r.firstChild : r.lastChild, l = o.content;
  return r.childCount > 1 && (s = 0), i < n - 1 && (l = Fn(l, e, t, n, i + 1, s)), i >= t && (l = e < 0 ? o.contentMatchAt(0).fillBefore(l, s <= i).append(l) : l.append(o.contentMatchAt(o.childCount).fillBefore(b.empty, !0))), r.replaceChild(e < 0 ? 0 : r.childCount - 1, o.copy(l));
}
function Xr(r, e, t) {
  return e < r.openStart && (r = new k(Fn(r.content, -1, e, r.openStart, 0, r.openEnd), e, r.openEnd)), t < r.openEnd && (r = new k(Fn(r.content, 1, t, r.openEnd, 0, 0), r.openStart, t)), r;
}
const ks = {
  thead: ["table"],
  tbody: ["table"],
...
function Hl(r) {
  ...
  return e ? (mn || (mn = e.defaultPolicy || e.createPolicy("ProseMirrorClipboard", { createHTML: (t) => t })), mn.createHTML(r)) : r;
}
function Ul(r) {
  let e = /^(\s*<meta [^>]*>)*/.exec(r);
  e && (r = r.slice(e[0].length));
  let t = xs().createElement("div"), n = /<([a-z][^>\s]+)/i.exec(r), i;
  if ((i = n && ks[n[1].toLowerCase()]) && (r = i.map((s) => "<" + s + ">").join("") + r + i.map((s) => "</" + s + ">").reverse().join("")), t.innerHTML = Hl(r), i)
    for (let s = 0; s < i.length; s++)
...
const H = {}, U = {}, Yl = { touchstart: !0, touchmove: !0 };
class Xl {
  constructor() {
...
function Ql(r) {
  for (let e in H) {
    ...
    r.dom.addEventListener(e, r.input.eventHandlers[e] = (n) => {
      ea(r, n) && !Xn(r, n) && (r.editable || !(n.type in U)) && t(r, n);
    }, Yl[e] ? { passive: !0 } : void 0);
  }
  K && r.dom.addEventListener("input", () => null), Vn(r);
}
function be(r, e) {
...
function Vn(r) {
  r.someProp("handleDOMEvents", (e) => {
    for (let t in e)
      r.input.eventHandlers[t] || r.dom.addEventListener(t, r.input.eventHandlers[t] = (n) => Xn(r, n));
  });
}
function Xn(r, e) {
...
function ta(r, e) {
  !Xn(r, e) && H[e.type] && (r.editable || !(e.type in U)) && H[e.type](r, e);
}
U.keydown = (r, e) => {
  let t = e;
  if (r.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Ms(r, t) && (r.input.lastKeyCode = t.keyCode, r.input.lastKeyCodeTime = Date.now(), !(ce && J && t.keyCode == 13)))
    ...
    } else r.someProp("handleKeyDown", (n) => n(r, t)) || Jl(r, t) ? t.preventDefault() : be(r, "key");
};
U.keyup = (r, e) => {
...
U.keypress = (r, e) => {
  let t = e;
  if (Ms(r, t) || !t.charCode || t.ctrlKey && !t.altKey || X && t.metaKey)
    return;
...
function sa(r, e, t, n, i) {
  return Qn(r, "handleClickOn", e, t, n) || r.someProp("handleClick", (s) => s(r, e, n)) || (i ? ia(r, t) : ra(r, t));
}
function oa(r, e, t, n) {
  return Qn(r, "handleDoubleClickOn", e, t, n) || r.someProp("handleDoubleClick", (i) => i(r, e, n));
}
function la(r, e, t, n) {
  return Qn(r, "handleTripleClickOn", e, t, n) || r.someProp("handleTripleClick", (i) => i(r, e, n)) || aa(r, t, n);
}
function aa(r, e, t) {
  if (t.button != 0)
    return !1;
...
const Ss = X ? "metaKey" : "ctrlKey";
H.mousedown = (r, e) => {
  let t = e;
  r.input.shiftKey = t.shiftKey;
  let n = Zn(r), i = Date.now(), s = "singleClick";
  i - r.input.lastClick.time < 500 && na(t, r.input.lastClick) && !t[Ss] && r.input.lastClick.button == t.button && (r.input.lastClick.type == "singleClick" ? s = "doubleClick" : r.input.lastClick.type == "doubleClick" && (s = "tripleClick")), r.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: s, button: t.button };
  let o = r.posAtCoords(Yt(t));
  o && (s == "singleClick" ? (r.input.mouseDown && r.input.mouseDown.done(), r.input.mouseDown = new ca(r, o, t, !!n)) : (s == "doubleClick" ? oa : la)(r, o.pos, o.inside, t) ? t.preventDefault() : be(r, "pointer"));
};
class ca {
  constructor(e, t, n, i) {
    this.view = e, this.pos = t, this.event = n, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!n[Ss], this.allowDefault = n.shiftKey;
    let s, o;
    if (t.inside > -1)
    ...
    }, 20), this.view.domObserver.start()), e.root.addEventListener("mouseup", this.up = this.up.bind(this)), e.root.addEventListener("mousemove", this.move = this.move.bind(this)), be(e, "pointer");
  }
  done() {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Yt(e))), this.updateAllowDefault(e), this.allowDefault || !t ? be(this.view, "pointer") : sa(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    J && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (Ge(this.view, T.near(this.view.state.doc.resolve(t.pos))), e.preventDefault()) : be(this.view, "pointer");
  }
  move(e) {
    this.updateAllowDefault(e), be(this.view, "pointer"), e.buttons == 0 && this.done();
  }
...
H.touchstart = (r) => {
  r.input.lastTouch = Date.now(), Zn(r), be(r, "pointer");
};
H.touchmove = (r) => {
  r.input.lastTouch = Date.now(), be(r, "pointer");
};
H.contextmenu = (r) => Zn(r);
function Ms(r, e) {
...
U.compositionstart = U.compositionupdate = (r) => {
  if (!r.composing) {
    ...
    if (e.selection instanceof N && (e.storedMarks || !t.textOffset && t.parentOffset && t.nodeBefore.marks.some((n) => n.type.spec.inclusive === !1)))
      r.markCursor = r.state.storedMarks || t.marks(), Vt(r, !0), r.markCursor = null;
    else if (Vt(r, !e.selection.empty), Z && e.selection.empty && t.parentOffset && !t.textOffset && t.nodeBefore.marks.length) {
...
U.compositionend = (r, e) => {
  r.composing && (r.input.composing = !1, r.input.compositionEndedAt = e.timeStamp, r.input.compositionPendingChanges = r.domObserver.pendingRecords().length ? r.input.compositionID : 0, r.input.compositionNode = null, r.input.compositionPendingChanges && Promise.resolve().then(() => r.domObserver.flush()), r.input.compositionID++, Cs(r, 20));
};
function Cs(r, e) {
  clearTimeout(r.input.composingTimeout), e > -1 && (r.input.composingTimeout = setTimeout(() => Vt(r), e));
}
function ws(r) {
  for (r.composing && (r.input.composing = !1, r.input.compositionEndedAt = ua()); r.input.compositionNodes.length > 0; )
...
function da(r) {
  ...
  if (!e.focusNode)
    return null;
  let t = rl(e.focusNode, e.focusOffset), n = il(e.focusNode, e.focusOffset);
  if (t && n && t != n) {
...
function Vt(r, e = !1) {
  if (!(ce && r.domObserver.flushingSoon >= 0)) {
    if (r.domObserver.forceFlush(), ws(r), e || r.docView && r.docView.dirty) {
      let t = _n(r), n = r.state.selection;
...
const ut = _ && Se < 15 || Qe && cl < 604;
H.copy = U.cut = (r, e) => {
  let t = e, n = r.state.selection, i = t.type == "cut";
  if (n.empty)
    return;
  let s = ut ? null : t.clipboardData, o = n.content(), { dom: l, text: a } = Yn(r, o);
  s ? (t.preventDefault(), s.clearData(), s.setData("text/html", l.innerHTML), s.setData("text/plain", a)) : ha(r, l), i && r.dispatch(r.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function pa(r) {
...
function ma(r, e) {
  ...
  setTimeout(() => {
    r.focus(), n.parentNode && n.parentNode.removeChild(n), t ? ht(r, n.value, null, i, e) : ht(r, n.textContent, n.innerHTML, i, e);
  }, 50);
}
function ht(r, e, t, n, i) {
  let s = ms(r, e, t, n, r.state.selection.$from);
  if (r.someProp("handlePaste", (a) => a(r, i, s || k.empty)))
    return !0;
  if (!s)
    return !1;
  let o = pa(s), l = o ? r.state.tr.replaceSelectionWith(o, n) : r.state.tr.replaceSelection(s);
...
U.paste = (r, e) => {
  ...
  if (r.composing && !ce)
    return;
  let n = ut ? null : t.clipboardData, i = r.input.shiftKey && r.input.lastKeyCode != 45;
  n && ht(r, Os(n), n.getData("text/html"), i, t) ? t.preventDefault() : ma(r, t);
};
class Ns {
  constructor(e, t, n) {
...
H.dragstart = (r, e) => {
  ...
  if (n && n.done(), !t.dataTransfer)
    return;
  let i = r.state.selection, s = i.empty ? null : r.posAtCoords(Yt(t)), o;
  ...
  let l = (o || r.state.selection).content(), { dom: a, text: c, slice: f } = Yn(r, l);
  (!t.dataTransfer.files.length || !J || Qi > 120) && t.dataTransfer.clearData(), t.dataTransfer.setData(ut ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", ut || t.dataTransfer.setData("text/plain", c), r.dragging = new Ns(f, Ts(r, t), o);
};
H.dragend = (r) => {
  let e = r.dragging;
  window.setTimeout(() => {
...
U.drop = (r, e) => {
  ...
  if (r.dragging = null, !t.dataTransfer)
    return;
  let i = r.posAtCoords(Yt(t));
  if (!i)
    return;
  let s = r.state.doc.resolve(i.pos), o = n && n.slice;
  o ? r.someProp("transformPasted", (p) => {
    o = p(o, r, !1);
  }) : o = ms(r, Os(t.dataTransfer), ut ? null : t.dataTransfer.getData("text/html"), !1, s);
  let l = !!(n && Ts(r, t));
  ...
  if (!o)
    return;
  t.preventDefault();
  let a = o ? qo(r.state.doc, s.pos, o) : s.pos;
  a == null && (a = s.pos);
  let c = r.state.tr;
  if (l) {
    let { node: p } = n;
  ...
  if (d && S.isSelectable(o.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(o.content.firstChild))
    ...
    c.mapping.maps[c.mapping.maps.length - 1].forEach((m, g, y, M) => p = M), c.setSelection(Gn(r, h, c.doc.resolve(p)));
  }
...
H.beforeinput = (r, e) => {
  if (J && ce && e.inputType == "deleteContentBackward") {
    r.domObserver.flushSoon();
    let { domChangeCount: n } = r.input;
    setTimeout(() => {
      if (r.input.domChangeCount != n || (r.dom.blur(), r.focus(), r.someProp("handleKeyDown", (s) => s(r, Ee(8, "Backspace")))))
        return;
...
class Lt {
  ...
  map(e, t, n, i) {
    ...
    return o ? null : new te(s - n, s - n, this);
  }
  valid() {
    return !0;
  }
...
class er {
  ...
  map(e, t, n, i) {
    ...
    return o.deleted || o.pos <= s.pos ? null : new te(s.pos - n, o.pos - n, this);
  }
  valid(e, t) {
  ...
  eq(e) {
    return this == e || e instanceof er && pt(this.attrs, e.attrs) && pt(this.spec, e.spec);
  }
  destroy() {
  }
}
...
class P {
  ...
  */
  mapInner(e, t, n, i, s) {
    ...
    return this.children.length ? ya(this.children, o || [], e, t, n, i, s) : o ? new P(o.sort(Be), Ke) : j;
  }
  /**
  ...
  */
  add(e, t) {
    return t.length ? this == j ? P.create(e, t) : this.addInner(e, t, 0) : this;
  }
  addInner(e, t, n) {
    let i, s = 0;
    e.forEach((l, a) => {
      ...
      if (f = Ds(t, l, c)) {
        for (i || (i = this.children.slice()); s < i.length && i[s] < a; )
          s += 3;
        i[s] == a ? i[s + 2] = i[s + 2].addInner(l, f, c + 1) : i.splice(s, 0, a, a + l.nodeSize, $t(f, l, c + 1, Pe)), s += 3;
      }
    });
    let o = Es(s ? As(t) : t, -n);
    for (let l = 0; l < o.length; l++)
      o[l].type.valid(e, o[l]) || o.splice(l--, 1);
    return new P(o.length ? this.local.concat(o).sort(Be) : this.local, i || this.children);
  }
  /**
  ...
  */
  ...
  removeInner(e, t) {
    ...
    return n == this.children && i == this.local ? this : i.length || n.length ? new P(i, n) : j;
  }
  forChild(e, t) {
    if (this == j)
      return this;
  ...
  */
  localsInner(e) {
    ...
    for (let n = 0; n < this.local.length; n++)
      this.local[n].type instanceof Ce || t.push(this.local[n]);
    return t;
  }
  forEachSet(e) {
    e(this);
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new me(e.every((t) => t instanceof P) ? e : e.reduce((t, n) => t.concat(n instanceof P ? n : n.members), []));
    }
  }
  forEachSet(e) {
    for (let t = 0; t < this.members.length; t++)
...
function ya(r, e, t, n, i, s, o) {
  ...
  if (a) {
    let c = ba(l, r, e, t, i, s, o), f = $t(c, n, 0, o);
    e = f.local;
  ...
  for (let t = 0; t < e.length - 1; t++) {
    ...
    if (n.from != n.to)
      for (let i = t + 1; i < e.length; i++) {
        let s = e[i];
        if (s.from == n.from) {
          s.to != n.to && (e == r && (e = r.slice()), e[i] = s.copy(s.from, n.to), Zr(e, i + 1, s.copy(n.to, s.to)));
          continue;
        } else {
          s.from < n.to && (e == r && (e = r.slice()), e[t] = n.copy(n.from, s.from), Zr(e, i, n.copy(s.from, n.to)));
          break;
        }
      }
  }
...
function gn(r) {
  ...
  return r.someProp("decorations", (t) => {
    let n = t(r.state);
    n && n != j && e.push(n);
  }), r.cursorWrapper && e.push(P.create(r.state.doc, [r.cursorWrapper.deco])), me.from(e);
}
const ka = {
  childList: !0,
  characterData: !0,
...
class Ma {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new Sa(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((n) => {
      for (let i = 0; i < n.length; i++)
        this.queue.push(n[i]);
      _ && Se <= 11 && n.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange() {
    if (Kr(this.view)) {
      if (this.suppressingSelectionUpdates)
        return ue(this.view);
      if (_ && Se <= 11 && !this.view.state.selection.empty) {
  ...
  flush() {
    ...
    t.length && (this.queue = []);
    let n = e.domSelectionRange(), i = !this.suppressingSelectionUpdates && !this.currentSelection.eq(n) && Kr(e) && !this.ignoreSelectionChange(n), s = -1, o = -1, l = !1, a = [];
    if (e.editable)
    ...
    let c = null;
    s < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && _t(n) && (c = _n(e)) && c.eq(T.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, ue(e), this.currentSelection.set(n), e.scrollToSelection()) : (s > -1 || i) && (s > -1 && (e.docView.markDirty(s, o), Ca(e)), this.handleDOMChange(s, o, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || ue(e), this.currentSelection.set(n));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (_ && Se <= 11 && e.addedNodes.length)
        for (let f = 0; f < e.addedNodes.length; f++) {
      ...
      let o = i && i.parentNode == e.target ? L(i) + 1 : 0, l = n.localPosFromDOM(e.target, o, -1), a = s && s.parentNode == e.target ? L(s) : e.target.childNodes.length, c = n.localPosFromDOM(e.target, a, 1);
      return { from: l, to: c };
...
function Ca(r) {
  if (!ei.has(r) && (ei.set(r, null), ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(r.dom).whiteSpace) !== -1)) {
    if (r.requiresGeckoHackNode = Z, ti)
      return;
...
function wa(r, e) {
  ...
  return r.dom.addEventListener("beforeinput", n, !0), document.execCommand("indent"), r.dom.removeEventListener("beforeinput", n, !0), t ? ni(r, t) : null;
}
function Oa(r, e) {
...
function Na(r, e, t) {
  ...
  if (f && r.dom.contains(f.nodeType == 1 ? f : f.parentNode) && (c = [{ node: f, offset: a.anchorOffset }], _t(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), J && r.input.lastKeyCode === 8)
    for (let g = s; g > i; g--) {
  ...
  let d = r.state.doc, u = r.someProp("domParser") || xe.fromSchema(r.state.schema), h = d.resolve(o), p = null, m = u.parse(n, {
    topNode: h.parent,
...
function Ta(r) {
  ...
  if (r.nodeName == "BR" && r.parentNode) {
    ...
    } else if (r.parentNode.lastChild == r || K && /^(tr|table)$/i.test(r.parentNode.nodeName))
      return { ignore: !0 };
  } else if (r.nodeName == "IMG" && r.getAttribute("mark-placeholder"))
    return { ignore: !0 };
  return null;
}
const Ea = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|img|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function Da(r, e, t, n, i) {
  ...
  if (r.input.compositionPendingChanges = 0, e < 0) {
    let w = r.input.lastSelectionTime > Date.now() - 50 ? r.input.lastSelectionOrigin : null, E = _n(r, w);
    if (E && !r.state.selection.eq(E)) {
      if (J && ce && r.input.lastKeyCode === 13 && Date.now() - 100 < r.input.lastKeyCodeTime && r.someProp("handleKeyDown", (ro) => ro(r, Ee(13, "Enter"))))
        return;
      let W = r.state.tr.setSelection(E);
      w == "pointer" ? W.setMeta("pointer", !0) : w == "key" && W.scrollIntoView(), s && W.setMeta("composition", s), r.dispatch(W);
    }
    return;
  }
  ...
  if (p && r.input.domChangeCount++, (Qe && r.input.lastIOSEnter > Date.now() - 225 || ce) && i.some((w) => w.nodeType == 1 && !Ea.test(w.nodeName)) && (!p || p.endA >= p.endB) && r.someProp("handleKeyDown", (w) => w(r, Ee(13, "Enter")))) {
  ...
  if (!p)
    if (n && a instanceof N && !a.empty && a.$head.sameParent(a.$anchor) && !r.composing && !(c.sel && c.sel.anchor != c.sel.head))
      ...
      if (c.sel) {
        let w = ri(r, r.state.doc, c.sel);
        if (w && !w.eq(r.state.selection)) {
          let E = r.state.tr.setSelection(w);
          s && E.setMeta("composition", s), r.dispatch(E);
        }
      }
      return;
    }
  r.state.selection.from < r.state.selection.to && p.start == p.endB && r.state.selection instanceof N && (p.start > r.state.selection.from && p.start <= r.state.selection.from + 2 && r.state.selection.from >= c.from ? p.start = r.state.selection.from : p.endA < r.state.selection.to && p.endA >= r.state.selection.to - 2 && r.state.selection.to <= c.to && (p.endB += r.state.selection.to - p.endA, p.endA = r.state.selection.to)), _ && Se <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  let m = c.doc.resolveNoCache(p.start - c.from), g = c.doc.resolveNoCache(p.endB - c.from), y = f.resolve(p.start), M = m.sameParent(g) && m.parent.inlineContent && y.end() >= p.endA;
  if ((Qe && r.input.lastIOSEnter > Date.now() - 225 && (!M || i.some((w) => w.nodeName == "DIV" || w.nodeName == "P")) || !M && m.pos < c.doc.content.size && (!m.sameParent(g) || !m.parent.inlineContent) && m.pos < g.pos && !/\S/.test(c.doc.textBetween(m.pos, g.pos, "", ""))) && r.someProp("handleKeyDown", (w) => w(r, Ee(13, "Enter")))) {
    r.input.lastIOSEnter = 0;
    return;
  }
  if (r.state.selection.anchor > p.start && Ia(f, p.start, p.endA, m, g) && r.someProp("handleKeyDown", (w) => w(r, Ee(8, "Backspace")))) {
    ce && J && r.domObserver.suppressSelectionUpdates();
    return;
  }
  J && p.endB == p.start && (r.input.lastChromeDelete = Date.now()), ce && !M && m.start() != g.start() && g.parentOffset == 0 && m.depth == g.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, g = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
    r.someProp("handleKeyDown", function(w) {
      return w(r, Ee(13, "Enter"));
    });
  }, 20));
  let C = p.start, A = p.endA, D = (w) => {
    let E = w || r.state.tr.replace(C, A, c.doc.slice(p.start - c.from, p.endB - c.from));
    if (c.sel) {
      let W = ri(r, E.doc, c.sel);
      W && !(J && r.composing && W.empty && (p.start != p.endB || r.input.lastChromeDelete < Date.now() - 100) && (W.head == C || W.head == E.mapping.map(A) - 1) || _ && W.empty && W.head == C) && E.setSelection(W);
    }
    return s && E.setMeta("composition", s), E.scrollIntoView();
  }, v;
  if (M)
    if (m.pos == g.pos) {
      _ && Se <= 11 && m.parentOffset == 0 && (r.domObserver.suppressSelectionUpdates(), setTimeout(() => ue(r), 20));
      let w = D(r.state.tr.delete(C, A)), E = f.resolve(p.start).marksAcross(f.resolve(p.endA));
      E && w.ensureMarks(E), r.dispatch(w);
    } else if (
      // Adding or removing a mark
      p.endA == p.endB && (v = Aa(m.parent.content.cut(m.parentOffset, g.parentOffset), y.parent.content.cut(y.parentOffset, p.endA - y.start())))
    ) {
      let w = D(r.state.tr);
      v.type == "add" ? w.addMark(C, A, v.mark) : w.removeMark(C, A, v.mark), r.dispatch(w);
    } else if (m.parent.child(m.index()).isText && m.index() == g.index() - (g.textOffset ? 0 : 1)) {
      let w = m.parent.textBetween(m.parentOffset, g.parentOffset), E = () => D(r.state.tr.insertText(w, C, A));
      r.someProp("handleTextInput", (W) => W(r, C, A, w, E)) || r.dispatch(E());
    } else
      r.dispatch(D());
  else
    r.dispatch(D());
...
function Ia(r, e, t, n, i) {
  ...
  if (s.parentOffset < s.parent.content.size || !s.parent.isTextblock)
    return !1;
  let o = r.resolve(yn(s, !0, !0));
  return !o.parent.isTextblock || o.pos > t || yn(o, !0, !1) < t ? !1 : n.parent.content.cut(n.parentOffset).eq(o.parent.content);
}
function yn(r, e, t) {
...
function Ra(r, e, t, n, i) {
  ...
  if (o < s && r.size < e.size) {
    let a = n <= s && n >= o ? s - n : 0;
    s -= a, s && s < e.size && ii(e.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1), l = s + (l - o), o = s;
  } else if (l < s) {
    let a = n <= s && n >= l ? s - n : 0;
    s -= a, s && s < r.size && ii(r.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1), o = s + (o - l), l = s;
  }
...
class Is {
  ...
  */
  update(e) {
    e.handleDOMEvents != this._props.handleDOMEvents && Vn(this);
    let t = this._props;
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = ai(this);
      Pa(h, this.nodeViews) && (this.nodeViews = h, s = !0);
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && Vn(this), this.editable = li(this), oi(this);
    let a = gn(this), c = si(this), f = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", d = s || !this.docView.matchesNode(e.doc, c, a);
    (d || !e.selection.eq(i.selection)) && (o = !0);
    let u = f == "preserve" && o && this.dom.style.overflowAnchor == null && ul(this);
    if (o) {
      this.domObserver.stop();
      let h = d && (_ || J) && !this.composing && !i.selection.empty && !e.selection.empty && va(i.selection, e.selection);
      if (d) {
        let p = J ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = da(this)), (s || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = Lr(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && zl(this)) ? ue(this, h) : (us(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((n = this.dragging) === null || n === void 0) && n.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), f == "reset" ? this.dom.scrollTop = 0 : f == "to selection" ? this.scrollToSelection() : u && hl(u);
  }
  /**
  @internal
  */
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Ns(e.slice, e.move, i < 0 ? void 0 : S.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && pl(this.dom), ue(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Zl(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], gn(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, tl());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return e ? K && this.root.nodeType === 11 && ol(this.dom.ownerDocument) == this.dom && wa(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  /**
  @internal
  */
...
Is.prototype.dispatch = function(r) {
...
function si(r) {
  ...
  }), e.translate || (e.translate = "no"), [te.node(0, r.state.doc.content.size, e)];
}
function oi(r) {
  if (r.markCursor) {
    let e = document.createElement("img");
    e.className = "ProseMirror-separator", e.setAttribute("mark-placeholder", "true"), e.setAttribute("alt", ""), r.cursorWrapper = { dom: e, deco: te.widget(r.state.selection.from, e, { raw: !0, marks: r.markCursor }) };
  } else
...
var we = {
  ...
  221: "}",
  222: '"'
}, Ba = typeof navigator < "u" && /Mac/.test(navigator.platform), za = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var $ = 0; $ < 10; $++) we[48 + $] = we[96 + $] = String($);
for (var $ = 1; $ <= 24; $++) we[$ + 111] = "F" + $;
for (var $ = 65; $ <= 90; $++)
  we[$] = String.fromCharCode($ + 32), Wt[$] = String.fromCharCode($);
for (var bn in we) Wt.hasOwnProperty(bn) || (Wt[bn] = we[bn]);
function Fa(r) {
  var e = Ba && r.metaKey && r.shiftKey && !r.ctrlKey && !r.altKey || za && r.shiftKey && r.key && r.key.length == 1 || r.key == "Unidentified", t = !e && r.key || (r.shiftKey ? Wt : we)[r.keyCode] || r.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const Va = typeof navigator < "u" && /Mac|iP(hone|[oa]d)/.test(navigator.platform), La = typeof navigator < "u" && /Win/.test(navigator.platform);
function $a(r) {
...
function Ja(r) {
  ...
  return function(t, n) {
    ...
    if (i.length == 1 && i != " ") {
      ...
      !(La && n.ctrlKey && n.altKey) && (s = we[n.keyCode]) && s != i) {
        let l = e[kn(s, n)];
        if (l && l(t.state, t.dispatch, t))
          return !0;
      }
...
const nr = (r, e) => r.selection.empty ? !1 : (e && e(r.tr.deleteSelection().scrollIntoView()), !0);
function Rs(r, e) {
...
const vs = (r, e, t) => {
  ...
  if (n.parent.content.size == 0 && (Ze(s, "end") || S.isSelectable(s)))
    for (let o = n.depth; ; o--) {
      let l = Ht(r.doc, n.before(o), n.after(o), k.empty);
      if (l && l.slice.size < l.to - l.from) {
        if (e) {
          let a = r.tr.step(l);
          a.setSelection(Ze(s, "end") ? T.findFrom(a.doc.resolve(a.mapping.map(i.pos, -1)), -1) : S.create(a.doc, i.pos - s.nodeSize)), e(a.scrollIntoView());
        }
        return !0;
      }
...
const Fs = (r, e, t) => {
  ...
  if (n.parent.content.size == 0 && (Ze(s, "start") || S.isSelectable(s))) {
    ...
    if (o && o.slice.size < o.to - o.from) {
      if (e) {
        let l = r.tr.step(o);
        l.setSelection(Ze(s, "start") ? T.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1) : S.create(l.doc, l.mapping.map(i.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const Ha = (r, e) => {
  ...
  if (n) {
    if (t.node.isTextblock || !Oe(r.doc, t.from))
      return !1;
    i = t.from;
  } else if (i = Kt(r.doc, t.from, -1), i == null)
    return !1;
  if (e) {
    let s = r.tr.join(i);
  ...
  let t = r.selection, n;
  if (t instanceof S) {
    if (t.node.isTextblock || !Oe(r.doc, t.to))
      return !1;
    n = t.to;
...
function Ya(r) {
  return (e, t) => {
    ...
    for (let h = n.depth; ; h--)
      if (n.node(h).isBlock) {
        a = n.end(h) == n.pos + (n.depth - h), c = n.start(h) == n.pos - (n.depth - h), l = sr(n.node(h - 1).contentMatchAt(n.indexAfter(h - 1))), s.unshift(a && l ? { type: l } : null), o = h;
        break;
      } else {
        if (h == 1)
          return !1;
    ...
    if (u || (s[0] = l ? { type: l } : null, u = de(f.doc, d, s.length, s)), !u)
      return !1;
...
function Za(r, e, t) {
  ...
  return !n || !i || !n.type.compatibleContent(i.type) ? !1 : !n.content.size && e.parent.canReplace(s - 1, s) ? (t && t(r.tr.delete(e.pos - n.nodeSize, e.pos).scrollIntoView()), !0) : !e.parent.canReplace(s, s + 1) || !(i.isTextblock || Oe(r.doc, e.pos)) ? !1 : (t && t(r.tr.join(e.pos).scrollIntoView()), !0);
}
function js(r, e, t, n) {
  ...
  if (c && (o = (l = i.contentMatchAt(i.childCount)).findWrapping(s.type)) && l.matchType(o[0] || s.type).validEnd) {
    if (t) {
      ...
      p = b.from(i.copy(p));
      let m = r.tr.step(new z(e.pos - 1, h, e.pos, h, new k(p, 1, 0), o.length, !0)), g = m.doc.resolve(h + 2 * o.length);
      g.nodeAfter && g.nodeAfter.type == i.type && Oe(m.doc, g.pos) && m.join(g.pos), t(m.scrollIntoView());
    }
    return !0;
  }
  let f = s.type.spec.isolating || n > 0 && a ? null : T.findFrom(e, 1), d = f && f.$from.blockRange(f.$to), u = d && et(d);
  if (u != null && u >= e.depth)
    ...
    if (h.canReplace(h.childCount, h.childCount, m.content)) {
      if (t) {
        ...
        for (let C = p.length - 1; C >= 0; C--)
          y = b.from(p[C].copy(y));
        let M = r.tr.step(new z(e.pos - p.length, e.pos + s.nodeSize, e.pos + g, e.pos + s.nodeSize - g, new k(y, p.length, 0), 0, !0));
        t(M.scrollIntoView());
      }
      return !0;
    }
...
const ec = Js(-1), tc = Js(1);
function nc(r, e = null) {
  return function(t, n) {
    let { $from: i, $to: s } = t.selection, o = i.blockRange(s), l = o && Kn(o, r, e);
...
function lc(r, e, t, n) {
  ...
  s < o && (i.step(new z(s - 1, o, s, o, new k(b.from(t.create(null, n.parent.copy())), 1, 0), 1, !0)), n = new vt(i.doc.resolve(n.$from.pos), i.doc.resolve(o), n.depth));
  const l = et(n);
  if (l == null)
    return !1;
  i.lift(n, l);
...
function ac(r, e, t) {
  ...
  return n.step(new z(d - (l ? 1 : 0), u + (a ? 1 : 0), d + 1, u - 1, new k((l ? b.empty : b.from(i.copy(b.empty))).append(a ? b.empty : b.from(i.copy(b.empty))), l ? 0 : 1, a ? 0 : 1), l ? 0 : 1)), e(n.scrollIntoView()), !0;
}
function cc(r) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(e.tr.step(new z(u - (c ? 3 : 1), h, u, h, d, 1, !0)).scrollIntoView());
    }
    return !0;
  };
}
...
function qs(r) {
  const e = [], { nodeExtensions: t, markExtensions: n } = Zt(r), i = [...t, ...n], s = {
    default: null,
    rendered: !0,
    renderHTML: null,
    parseHTML: null,
...
function O(r, e = void 0, ...t) {
  return Ks(r) ? e ? r.bind(e)(...t) : r(...t) : r;
}
function uc(r = {}) {
...
function pc(r, e) {
  var t;
  const n = qs(r), { nodeExtensions: i, markExtensions: s } = Zt(r), o = (t = i.find((c) => x(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
...
function Ct(r) {
  ...
  return o.forEach((u) => {
    ...
    const p = a.state.tr, m = Xt({
      ...
      to: i
    }, { commands: y, chain: M, can: C } = new Qt({
      editor: t,
      state: m
    });
    u.handler({
...
function Sc(r) {
  const { editor: e, state: t, from: n, to: i, rule: s, pasteEvent: o, dropEvent: l } = r, { commands: a, chain: c, can: f } = new Qt({
    editor: e,
    state: t
  }), d = [];
  return t.doc.nodesBetween(n, i, (h, p) => {
    ...
    xc(y, s.find, o).forEach((C) => {
      if (C.index === void 0)
        return;
      const A = m + C.index + 1, D = A + C[0].length, v = {
...
function Cc(r) {
  ...
  return t.map((f) => new oe({
    ...
    appendTransaction: (d, u, h) => {
      ...
      if (M) {
        let { text: D } = y;
        typeof D == "string" ? D = D : D = lr(b.from(D), h.schema);
        const { from: v } = y, w = v + D.length, E = Mc(D);
        return a({
          rule: f,
          state: h,
          from: v,
      ...
      const C = u.doc.content.findDiffStart(h.doc.content), A = u.doc.content.findDiffEnd(h.doc.content);
      if (!(!kc(C) || !A || C === A.b))
        return a({
          rule: f,
          state: h,
...
class Ue {
  ...
  get plugins() {
    const { editor: e } = this, t = Ue.sort([...this.extensions].reverse()), n = [], i = [], s = t.map((o) => {
      ...
      hi(o, e.options.enableInputRules) && u && n.push(...u());
      const h = x(o, "addPasteRules", l);
      hi(o, e.options.enablePasteRules) && h && i.push(...h());
   ...
   */
  get nodeViews() {
    const { editor: e } = this, { nodeExtensions: t } = Zt(this.extensions);
      ...
      new oe({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: r } = this, { state: e, schema: t } = r, { doc: n, selection: i } = e, { ranges: s } = i, o = Math.min(...s.map((f) => f.$from.pos)), l = Math.max(...s.map((f) => f.$to.pos)), a = _s(t);
...
}, Dc = (r) => (e) => r(e), Ac = () => ({ state: r, dispatch: e }) => $s(r, e), Ic = (r, e) => ({ editor: t, tr: n }) => {
...
function cr(r, e, t) {
  ...
  if ((!i.node || !i.node.marks.some((f) => f.type === e)) && (i = r.parent.childBefore(r.parentOffset)), !i.node || !i.node.marks.some((f) => f.type === e) || (t = t || ((n = i.node.marks[0]) === null || n === void 0 ? void 0 : n.attrs), !Gs([...i.node.marks], e, t)))
    return;
  let o = i.index, l = r.start() + i.offset, a = o + 1, c = l + i.node.nodeSize;
  for (; o > 0 && pi([...r.parent.child(o - 1).marks], e, t); )
    o -= 1, l -= r.parent.child(o).nodeSize;
  for (; a < r.parent.childCount && pi([...r.parent.child(a).marks], e, t); )
...
const Vc = (r, e = {}) => ({ tr: t, state: n, dispatch: i }) => {
  const s = Te(r, n.schema), { doc: o, selection: l } = t, { $from: a, from: c, to: f } = l;
  if (i) {
    const d = cr(a, s, e);
...
function Xs(r, e = null) {
  ...
  return e === "all" ? N.create(r, fe(0, i, s), fe(r.content.size, i, s)) : N.create(r, fe(e, i, s), fe(e, i, s));
}
function Qs() {
...
const $c = (r = null, e = {}) => ({ editor: t, view: n, tr: i, dispatch: s }) => {
  ...
  const o = () => {
    (nn() || Qs()) && n.dom.focus(), requestAnimationFrame(() => {
      t.isDestroyed || (n.focus(), e != null && e.scrollIntoView && t.commands.scrollIntoView());
    });
  };
  if (n.hasFocus() && r === null || r === !1)
    return !0;
  if (s && r === null && !Ys(t.state.selection))
    return o(), !0;
  const l = Xs(i.doc, r) || t.state.selection, a = t.state.selection.eq(l);
  return s && (a || i.setSelection(l), a && i.storedMarks && i.setStoredMarks(i.storedMarks), o()), !0;
}, Wc = (r, e) => (t) => r.every((n, i) => e(n, { ...t, index: i })), jc = (r, e) => ({ tr: t, commands: n }) => n.insertContentAt({ from: t.selection.from, to: t.selection.to }, r, e), Zs = (r) => {
  const e = r.childNodes;
  for (let t = e.length - 1; t >= 0; t -= 1) {
    const n = e[t];
    n.nodeType === 3 && n.nodeValue && /^(\n\s\s|\n)$/.test(n.nodeValue) ? r.removeChild(n) : n.nodeType === 1 && Zs(n);
  }
  return r;
};
function Nt(r) {
...
function mt(r, e, t) {
  if (r instanceof ke || r instanceof b)
    return r;
  t = {
    slice: !0,
    parseOptions: {},
  ...
  if (n)
    try {
      ...
      return console.warn("[tiptap warn]: Invalid content.", "Passed value:", r, "Error:", s), mt("", e, t);
    }
  if (i) {
    if (t.errorOnInvalidContent) {
      let o = !1, l = "";
      ...
      if (t.slice ? xe.fromSchema(a).parseSlice(Nt(r), t.parseOptions) : xe.fromSchema(a).parse(Nt(r), t.parseOptions), t.errorOnInvalidContent && o)
        throw new Error("[tiptap error]: Invalid HTML content", { cause: new Error(`Invalid element found: ${l}`) });
    }
    const s = xe.fromSchema(e);
...
const qc = (r) => !("type" in r), Kc = (r, e, t) => ({ tr: n, dispatch: i, editor: s }) => {
  ...
  return !0;
}, Hc = () => ({ state: r, dispatch: e }) => Ha(r, e), Uc = () => ({ state: r, dispatch: e }) => Ua(r, e), _c = () => ({ state: r, dispatch: e }) => vs(r, e), Gc = () => ({ state: r, dispatch: e }) => Fs(r, e), Yc = () => ({ state: r, dispatch: e, tr: t }) => {
  try {
...
function gt(r, e, t = {}) {
  const { from: n, to: i, empty: s } = r.selection, o = e ? F(e, r.schema) : null, l = [];
...
const nf = (r, e = {}) => ({ state: t, dispatch: n }) => {
  const i = F(r, t.schema);
  return gt(t, i, e) ? _a(t, n) : !1;
}, rf = () => ({ state: r, dispatch: e }) => Ws(r, e), sf = (r) => ({ state: e, dispatch: t }) => {
  const n = F(r, e.schema);
  return oc(n)(e, t);
}, of = () => ({ state: r, dispatch: e }) => Ls(r, e);
function rn(r, e) {
...
const lf = (r, e) => ({ tr: t, state: n, dispatch: i }) => {
  ...
  return l ? (l === "node" && (s = F(r, n.schema)), l === "mark" && (o = Te(r, n.schema)), i && t.selection.ranges.forEach((a) => {
    n.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, f) => {
      s && s === c.type && t.setNodeMarkup(f, void 0, mi(c.attrs, e)), o && c.marks.length && c.marks.forEach((d) => {
        o === d.type && t.addMark(f, f + c.nodeSize, o.create(mi(d.attrs, e)));
      });
    });
  }), !0) : !1;
  ...
  return !0;
}, ff = () => ({ state: r, dispatch: e }) => Bs(r, e), df = () => ({ state: r, dispatch: e }) => Vs(r, e), uf = () => ({ state: r, dispatch: e }) => Qa(r, e), hf = () => ({ state: r, dispatch: e }) => tc(r, e), pf = () => ({ state: r, dispatch: e }) => ec(r, e);
function $n(r, e, t = {}, n = {}) {
  return mt(r, e, {
    slice: !1,
    parseOptions: t,
...
function to(r, e) {
  const t = Te(e, r.schema), { from: n, to: i, empty: s } = r.selection, o = [];
...
function kf(r, e) {
  const t = F(e, r.schema), { from: n, to: i } = r.selection, s = [];
...
function xf(r, e) {
  ...
  return t === "node" ? kf(r, e) : t === "mark" ? to(r, e) : {};
}
...
function no(r, e, t) {
  ...
  return r === e ? t.resolve(r).marks().forEach((i) => {
    const s = t.resolve(r), o = cr(s, i.type);
    o && n.push({
      mark: i,
      ...o
    });
...
function Wn(r, e, t = {}) {
  const { empty: n, ranges: i } = r.selection, s = e ? Te(e, r.schema) : null;
  if (n)
...
function Cf(r, e, t = {}) {
  if (!e)
    return gt(r, null, t) || Wn(r, null, t);
  const n = rn(e, r.schema);
  return n === "node" ? gt(r, e, t) : n === "mark" ? Wn(r, e, t) : !1;
}
function gi(r, e) {
  const { nodeExtensions: t } = Zt(e), n = t.find((o) => o.name === r);
  if (!n)
    return !1;
  const i = {
    name: n.name,
...
function dr(r, { checkChildren: e = !0, ignoreWhitespace: t = !1 } = {}) {
  var n;
  if (t) {
  ...
  if (e) {
    ...
    return r.content.forEach((s) => {
      i !== !1 && (dr(s, { ignoreWhitespace: t, checkChildren: e }) || (i = !1));
    }), i;
  }
  return !1;
}
...
const Of = (r, e = {}) => ({ tr: t, state: n, dispatch: i }) => {
  const { selection: s } = t, { empty: o, ranges: l } = s, a = Te(r, n.schema);
  if (i)
    if (o) {
      const c = to(n, a);
  ...
  const s = F(r, t.schema);
  let o;
  return t.selection.$anchor.sameParent(t.selection.$head) && (o = t.selection.$anchor.parent.attrs), s.isTextblock ? i().command(({ commands: l }) => fi(s, { ...o, ...e })(t) ? !0 : l.clearNodes()).command(({ state: l }) => fi(s, { ...o, ...e })(l, n)).run() : (console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'), !1);
  ...
  if (t) {
    const { doc: n } = e, { from: i, to: s } = typeof r == "number" ? { from: r, to: r } : r, o = N.atStart(n).from, l = N.atEnd(n).to, a = fe(i, o, l), c = fe(s, o, l), f = N.create(n, a, c);
    e.setSelection(f);
  }
  return !0;
...
const If = ({ keepMarks: r = !0 } = {}) => ({ tr: e, state: t, dispatch: n, editor: i }) => {
  ...
  if (s instanceof S && s.node.isBlock)
    return !l.parentOffset || !de(o, l.pos) ? !1 : (n && (r && yi(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  ...
  if (!h && !p && de(e.doc, e.mapping.map(l.pos), 1, u ? [{ type: u }] : void 0) && (p = !0, h = u ? [
    ...
    r && yi(t, i.extensionManager.splittableMarks), e.scrollIntoView();
  }
  return p;
}, Rf = (r, e = {}) => ({ tr: t, state: n, dispatch: i, editor: s }) => {
  var o;
  const l = F(r, n.schema), { $from: a, $to: c } = n.selection, f = n.selection.node;
  ...
  if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
    ...
    if (i) {
      ...
      for (let E = a.depth - M; E >= a.depth - 3; E -= 1)
        y = b.from(a.node(E).copy(y));
      const C = a.indexAfter(-1) < a.node(-2).childCount ? 1 : a.indexAfter(-2) < a.node(-3).childCount ? 2 : 3, A = {
        ...Dt(u, a.node().type.name, a.node().attrs),
        ...e
      ...
      const v = a.before(a.depth - (M - 1));
      t.replace(v, a.after(-C), new k(y, 4 - M, 0));
      let w = -1;
      t.doc.nodesBetween(v, t.doc.content.size, (E, W) => {
        if (w > -1)
          return !1;
        E.isTextblock && E.content.size === 0 && (w = W + 1);
      }), w > -1 && t.setSelection(N.near(t.doc.resolve(w))), t.scrollIntoView();
    }
    return !0;
  }
  const h = c.pos === a.end() ? d.contentMatchAt(0).defaultType : null, p = {
    ...Dt(u, d.type.name, d.attrs),
    ...e
  }, m = {
    ...Dt(u, a.node().type.name, a.node().attrs),
    ...e
  ...
  if (!de(t.doc, a.pos, 2))
    return !1;
  if (i) {
    const { selection: y, storedMarks: M } = n, { splittableMarks: C } = s.extensionManager, A = M || y.$to.parentOffset && y.$from.marks();
    if (t.split(a.pos, 2, g).scrollIntoView(), !A || !i)
      return !0;
    const D = A.filter((v) => C.includes(v.type.name));
    t.ensureMarks(D);
  }
  return !0;
}, Sn = (r, e) => {
  ...
  return t.node.type === (i == null ? void 0 : i.type) && Oe(r.doc, t.pos) && r.join(t.pos), !0;
}, Mn = (r, e) => {
  const t = fr((o) => o.type === e)(r.selection);
  if (!t)
    return !0;
  ...
  if (n === void 0)
    return !0;
  const i = r.doc.nodeAt(n);
  return t.node.type === (i == null ? void 0 : i.type) && Oe(r.doc, n) && r.join(n), !0;
}, vf = (r, e, t, n = {}) => ({ editor: i, tr: s, state: o, dispatch: l, chain: a, commands: c, can: f }) => {
  const { extensions: d, splittableMarks: u } = i.extensionManager, h = F(r, o.schema), p = F(e, o.schema), { selection: m, storedMarks: g } = o, { $from: y, $to: M } = m, C = y.blockRange(M), A = g || m.$to.parentOffset && m.$from.marks();
  if (!C)
    return !1;
  const D = fr((v) => gi(v.type.name, d))(m);
  if (C.depth >= 1 && D && C.depth - D.depth <= 1) {
    if (D.node.type === h)
      return c.liftListItem(p);
    if (gi(D.node.type.name, d) && h.validContent(D.node.content) && l)
      return a().command(() => (s.setNodeMarkup(D.pos, h), !0)).command(() => Sn(s, h)).command(() => Mn(s, h)).run();
  }
  return !t || !A || !l ? a().command(() => f().wrapInList(h, n) ? !0 : c.clearNodes()).wrapInList(h, n).command(() => Sn(s, h)).command(() => Mn(s, h)).run() : a().command(() => {
    const v = f().wrapInList(h, n), w = A.filter((E) => u.includes(E.type.name));
    return s.ensureMarks(w), v ? !0 : c.clearNodes();
  }).wrapInList(h, n).command(() => Sn(s, h)).command(() => Mn(s, h)).run();
}, Pf = (r, e = {}, t = {}) => ({ state: n, commands: i }) => {
  const { extendEmptyMarkRange: s = !1 } = t, o = Te(r, n.schema);
  return Wn(n, o, e) ? i.unsetMark(o, { extendEmptyMarkRange: s }) : i.setMark(o, e);
}, Bf = (r, e, t = {}) => ({ state: n, commands: i }) => {
  const s = F(r, n.schema), o = F(e, n.schema), l = gt(n, s, t);
  let a;
  ...
  var s;
  const { extendEmptyMarkRange: o = !1 } = e, { selection: l } = t, a = Te(r, n.schema), { $from: c, empty: f, ranges: d } = l;
  if (!i)
    return !0;
  if (f && o) {
    let { from: u, to: h } = l;
    const p = (s = c.marks().find((g) => g.type === a)) === null || s === void 0 ? void 0 : s.attrs, m = cr(c, a, p);
...
}), Uf = new We("focusEvents"), _f = ne.create({
  name: "focusEvents",
  addProseMirrorPlugins() {
    const { editor: r } = this;
    return [
...
class De {
  ...
  get parent() {
    ...
    return new De(t, this.editor);
  }
  get before() {
    let e = this.resolvedPos.doc.resolve(this.from - (this.isBlock ? 1 : 2));
    return e.depth !== this.depth && (e = this.resolvedPos.doc.resolve(this.from - 3)), new De(e, this.editor);
  }
  get after() {
    let e = this.resolvedPos.doc.resolve(this.to + (this.isBlock ? 2 : 1));
    return e.depth !== this.depth && (e = this.resolvedPos.doc.resolve(this.to + 3)), new De(e, this.editor);
  }
  get children() {
    const e = [];
    return this.node.content.forEach((t, n) => {
      ...
      if (!i && l.depth <= this.depth)
        return;
      const a = new De(l, this.editor, i, i ? t : null);
      i && (a.actualDepth = this.depth + 1), e.push(new De(l, this.editor, i, i ? t : null));
    }), e;
  }
  get firstChild() {
...
class sd extends fc {
   ...
   */
  registerPlugin(e, t) {
    const n = Ks(t) ? t(e, [...this.state.plugins]) : [...this.state.plugins, e], i = this.state.reconfigure({ plugins: n });
  ...
  createView() {
    ...
    let t;
    try {
      t = $n(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: this.options.enableContentCheck });
    } catch (o) {
      ...
      }), t = $n(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: !1 });
    }
    const n = Xs(t, this.options.autofocus);
    this.view = new Is(this.options.element, {
   ...
   */
  getHTML() {
    return lr(this.state.doc.content, this.schema);
  }
  /**
  ...
  return new en({
    ...
    handler: ({ state: e, range: t, match: n }) => {
      ...
      if (o) {
        ...
        if (no(t.from, t.to, e.doc).filter((h) => h.mark.type.excluded.find((m) => m === r.type && m !== h.mark.type)).filter((h) => h.to > c).length)
          return null;
...
function cd(r) {
  return new en({
    ...
    handler: ({ state: e, range: t, match: n, chain: i }) => {
      ...
      f && f.type === r.type && Oe(o.doc, t.from - 1) && (!r.joinPredicate || r.joinPredicate(n, f)) && o.join(t.from - 1);
    }
  });
}
class jn {
...
class fd {
  ...
  onDragStart(e) {
    ...
    let u = 0, h = 0;
    if (this.dom !== d) {
      const M = this.dom.getBoundingClientRect(), C = d.getBoundingClientRect(), A = (i = e.offsetX) !== null && i !== void 0 ? i : (s = e.nativeEvent) === null || s === void 0 ? void 0 : s.offsetX, D = (o = e.offsetY) !== null && o !== void 0 ? o : (l = e.nativeEvent) === null || l === void 0 ? void 0 : l.offsetY;
      u = C.x - M.x + A, h = C.y - M.y + D;
    }
   ...
   */
  ignoreMutation(e) {
    return !this.dom || !this.contentDOM ? !0 : typeof this.options.ignoreMutation == "function" ? this.options.ignoreMutation({ mutation: e }) : this.node.isLeaf || this.node.isAtom ? !0 : e.type === "selection" || this.dom.contains(e.target) && e.type === "childList" && (nn() || Qs()) && this.editor.isFocused && [
  ...
  return new Hs({
    ...
    handler: ({ state: e, range: t, match: n, pasteEvent: i }) => {
      ...
      if (l) {
        ...
        if (no(t.from, t.to, e.doc).filter((p) => p.mark.type.excluded.find((g) => g === r.type && g !== p.mark.type)).filter((p) => p.to > d).length)
          return null;
...
function pd(r) {
  return new Hs({
    ...
    handler({ match: e, chain: t, range: n, pasteEvent: i }) {
      const s = O(r.getAttributes, void 0, e, i), o = O(r.getContent, void 0, s);
      if (s === !1 || s === null)
        return null;
