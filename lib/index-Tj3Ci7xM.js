  ...
  return {
    ...
    propagate(e) {
      ...
      t: do {
        ...
        if (!(a & 244) && (l.flags = a | i | 8, !0) || a & 16 && !(a & 4) && (l.flags = a & -17 | i | 8, !0) || !(a & 224) && f(e, l) && (l.flags = a | 16 | i | 8, l.subs !== void 0)) {
          const g = l.subs;
          if (g !== void 0) {
        ...
        } else a & (4 | i) ? !(a & i) && a & 224 && f(e, l) && (l.flags = a | i) : (l.flags = a | i | 8, (a & 10) === 2 && (s !== void 0 ? s.depsTail.nextDep = l.deps : n = l, s = l));
    ...
    t: do {
      ...
      if (i) {
        ...
        do {
          ...
          if (r) {
            if (t(l)) {
              (e = a.prevSub) !== void 0 ? (a.prevSub = void 0, m(l.subs), l = e.sub) : l = a.sub;
              continue;
            }
          } else
            l.flags &= -65;
...
function P(t) {
  ...
  return u !== void 0 && C(o, u), _(o), K.bind(o);
}
function _(t) {
  const o = u;
  u = t, v(t);
...
const k = new tt(), S = O(c.lang);
function kt() {
  const [t, o] = G(S), n = E(() => k.buildLocalesHandler(t), [t]);
  return L(() => {
...
const vt = {
  t: (t, o) => k.buildLocalesHandler(S())(t, o)
};
export {
  ft as B,
  pt as C,
