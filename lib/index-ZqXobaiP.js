...
var c = (e, t, o) => t in e ? u(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : e[t] = o;
var p = (e, t, o) => c(e, typeof t != "symbol" ? t + "" : t, o);
import { useMemo as h, useEffect as b } from "react";
import { x as f, d as k } from "./index-7cuXJD5N.js";
import { h as v } from "./index-oWDQeNNi.js";
import { m as z } from "./mitt-9MHtJtHd.js";
const x = {
...
class A {
  ...
  buildLocalesHandler(t) {
    ...
    return function(r, n) {
      let l = o[r] || r;
      return n && Object.entries(n).forEach(([m, g]) => {
        l = l.replace(new RegExp(`\\{${m}\\}`, "g"), String(g));
      }), l;
    };
  }
}
const d = new A(), s = k(i.lang);
function B() {
  const [e, t] = f(s), o = h(() => d.buildLocalesHandler(e), [e]);
  return b(() => {
    const a = d.registerWatchLang((r) => {
      t(r);
    });
    return () => {
      a.unsubscribe();
...
const R = {
  t: (e, t) => d.buildLocalesHandler(s())(e, t)
};
export {
  x as a,
  C as b,
