...
import { E as u } from "./index-sel2RZJw.js";
import { jsxs as a, jsx as l } from "react/jsx-runtime";
import { useState as s, useCallback as f } from "react";
import { A as C } from "./ActionButton-D15ZSL0z.js";
import { C as h } from "./ColorPicker-CE9E7zao.js";
import { d as m } from "./debounce-M7Yt2bxB.js";
import { B as x } from "./button-CcHmDfB3.js";
import { I as v } from "./Icon-BXO4CVnL.js";
const L = u.create({
  name: "color",
  addOptions() {
    return {
...
function g(t) {
  ...
  function i(n) {
    var c;
    (c = t.action) == null || c.call(t, n);
  }
  function o() {
    var n;
    (n = t.action) == null || n.call(t, e);
  }
  const d = f(
    m((n) => {
      r(n);
  ...
  return /* @__PURE__ */ a("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    /* @__PURE__ */ l(C, { tooltip: t == null ? void 0 : t.tooltip, disabled: t == null ? void 0 : t.disabled, action: o, children: /* @__PURE__ */ l("span", { className: "richtext-flex richtext-items-center richtext-justify-center richtext-text-sm", children: /* @__PURE__ */ l(b, { fill: e || t.initialDisplayedColor }) }) }),
    /* @__PURE__ */ l(
      h,
      {
        selectedColor: e,
        ...
        children: /* @__PURE__ */ l(x, { variant: "ghost", size: "icon", className: "r!ichtext-h-[32px] !richtext-w-3", disabled: t == null ? void 0 : t.disabled, children: /* @__PURE__ */ l(v, { className: "!richtext-w-3 !richtext-h-3 richtext-text-zinc-500", name: "MenuDown" }) })
      }
    )
  ] });
}
const N = /* @__PURE__ */ L.extend({
  addOptions() {
    var t;
    return {
      ...
      button({ editor: e, t: r, extension: i }) {
        return {
          ...
          componentProps: {
            ...
            action: (o) => {
              o === void 0 && e.chain().focus().unsetColor().run(), typeof o == "string" && e.chain().focus().setColor(o).run();
            },
            isActive: () => {
