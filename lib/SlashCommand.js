import { E as A, a as O } from "./index-sel2RZJw.js";
import { a as D } from "./index-CJo9otU0.js";
import { S as P } from "./index-DW1SUnqL.js";
...
import { c as V } from "./index-BP_NLBls.js";
import { u as U, f as h } from "./index-ZqXobaiP.js";
import { I as q } from "./Icon-BXO4CVnL.js";
import { I as K, a as G } from "./checkbox-C8kjShPh.js";
import { Video as F } from "./Video.js";
import "./store-j-5VHU4U.js";
import { d as j, E as p } from "./events.constant-BTaUfYyd.js";
function W(i, m) {
  var R, v;
  const [t, n] = N(0), [e, o] = N(0), r = E(null), { t: s } = U(), u = E([]);
  z(m, () => ({
    onKeyDown: f
  })), M(() => {
    if (!r.current)
  ...
  function w() {
    ...
    if (i.items.length === 0)
      return !1;
    let l = t - 1, c = e;
    l < 0 && (c = e - 1, l = ((d = i.items[c]) == null ? void 0 : d.commands.length) - 1 || 0), c < 0 && (c = i.items.length - 1, l = i.items[c].commands.length - 1), n(l), o(c);
  }
  function b() {
    if (i.items.length === 0)
      return !1;
    ...
    let c = t + 1, d = e;
    l.length - 1 < c && (c = 0, d = e + 1), i.items.length - 1 < d && (d = 0), n(c), o(d);
  }
  function L() {
...
function J(i, m) {
  ...
  return i.forEach((n) => {
    n.name.toLowerCase() === "heading" && n.options.levels.forEach((e) => {
      t[0].commands.push({
        ...
        action: ({ editor: o, range: r }) => {
          o.chain().focus().deleteRange(r).setHeading({ level: e }).run();
        }
      });
    ...
    }), n.name.toLowerCase() === K.name && t[1].commands.push({
      name: "image",
      ...
      shouldBeHidden: (e) => e.isActive("columns"),
      action: ({ editor: e, range: o }) => {
        e.chain().focus().deleteRange(o).run(), G.setOpen(e.id, !0);
      }
    }), n.name.toLowerCase() === F.name && t[1].commands.push({
      name: "video",
    ...
    return [
      P({
        ...
        allow: ({ state: i, range: m }) => {
          var f, w, b;
          const t = i.doc.resolve(m.from), n = t.depth === 1, e = t.parent.type.name === "paragraph", o = ((f = t.parent.textContent) == null ? void 0 : f.charAt(0)) === "/", r = this.editor.isActive("column"), s = (b = t.parent.textContent) == null ? void 0 : b.slice(
            Math.max(0, (w = t.parent.textContent) == null ? void 0 : w.indexOf("/"))
          ), u = !(s != null && s.endsWith("  "));
          return (n && e && o || r && e && o) && u;
        },
        command: ({ editor: i, range: m, props: t }) => {
          const { view: n } = i;
          t.action({ editor: i, range: m }), n.focus();
        },
        items: ({ query: i, editor: m }) => J(m.extensionManager.extensions, this.options.renderGroupItem).map((r) => ({
          ...r,
        ...
        render: () => {
          ...
          return {
            onStart: (t) => {
              ...
              }, (o = n.dom.parentElement) == null || o.addEventListener("scroll", m), a == null || a[0].setProps({
                getReferenceClientRect: e,
            ...
            onUpdate(t) {
              ...
              (r = n.dom.parentElement) == null || r.addEventListener("scroll", o), t.editor.storage[x].rect = t.clientRect ? e() : {
                width: 0,
                height: 0,
                left: 0,
                top: 0,
            ...
            onKeyDown(t) {
              var n;
              return t.event.key === "Escape" ? (a == null || a[0].hide(), !0) : (a != null && a[0].state.isShown || a == null || a[0].show(), (n = i.ref) == null ? void 0 : n.onKeyDown(t));
            },
            onExit(t) {
              var n;
              if (a == null || a[0].hide(), m) {
