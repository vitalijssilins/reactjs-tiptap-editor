import { N as $t, m as Vt, R as Mt } from "./index-sel2RZJw.js";
import { N as jt, R as Bt } from "./index-CJo9otU0.js";
...
import { A as Gt } from "./ActionButton-D15ZSL0z.js";
import { u as Kt } from "./index-ZqXobaiP.js";
import { L as Xt } from "./label-BUeBtRLx.js";
import { I as Qt } from "./input-BQQ_iBrZ.js";
import { B as Jt } from "./button-CcHmDfB3.js";
import { P as Yt, a as Zt, b as en } from "./popover-B8VvcibZ.js";
import { I as tn } from "./Icon-BXO4CVnL.js";
const nn = "_verified_lvyh0_1", Ue = {
  ...
  brand: xn,
  twitterIcon: bn
}, En = "_verifiedOld_lcna5_1", Rn = "_verifiedBlue_lcna5_4", Nn = "_verifiedGovernment_lcna5_7", xe = {
  verifiedOld: En,
  verifiedBlue: Rn,
...
const Gn = (e) => ({
...
}), Tr = "_actions_n2anf_1", xr = "_like_n2anf_13", br = "_reply_n2anf_14", Er = "_copy_n2anf_15", Rr = "_likeIconWrapper_n2anf_27", Nr = "_likeCount_n2anf_30", Or = "_replyIconWrapper_n2anf_35", Ir = "_copyIconWrapper_n2anf_36", Lr = "_likeIcon_n2anf_27", kr = "_replyIcon_n2anf_35", Cr = "_copyIcon_n2anf_36", Dr = "_replyText_n2anf_56", qr = "_copyText_n2anf_57", L = {
  actions: Tr,
  like: xr,
  reply: br,
  copy: Er,
  ...
  return Pe(() => {
    ...
    children: [
      /* @__PURE__ */ r("div", {
        className: L.copyIconWrapper,
        children: t ? /* @__PURE__ */ r("svg", {
          viewBox: "0 0 24 24",
          className: L.copyIcon,
          "aria-hidden": "true",
          children: /* @__PURE__ */ r("g", {
            children: /* @__PURE__ */ r("path", {
  ...
  return /* @__PURE__ */ g("div", {
    ...
    children: [
      /* @__PURE__ */ g("a", {
        ...
        children: [
          /* @__PURE__ */ r("div", {
            className: L.likeIconWrapper,
            children: /* @__PURE__ */ r("svg", {
              viewBox: "0 0 24 24",
              className: L.likeIcon,
              "aria-hidden": "true",
              children: /* @__PURE__ */ r("g", {
                children: /* @__PURE__ */ r("path", {
...
const W = /* @__PURE__ */ new WeakMap(), U = () => {
  ...
  /*#__NOINLINE__*/
  U()
), $e = Object, m = (e) => e === I, M = (e) => typeof e == "function", z = (e, t) => ({
  ...e,
  ...t
}), Nt = (e) => M(e.then), Oe = {}, ve = {}, ze = "undefined", ue = typeof window != ze, Ve = typeof document != ze, mo = ue && "Deno" in window, po = () => ue && typeof window.requestAnimationFrame != ze, Ot = (e, t) => {
  const n = W.get(e);
  return [
    // Getter
    () => !m(t) && e.get(t) || Oe,
...
const vo = () => Me, [je, Be] = ue && window.addEventListener ? [
  ...
  initFocus: wo,
  initReconnect: yo
}, _t = !de.useId, le = !ue || mo, xo = (e) => po() ? window.requestAnimationFrame(e) : setTimeout(e, 1), Ie = le ? Pe : Ut, Le = typeof navigator < "u" && navigator.connection, ht = !le && Le && ([
  "slow-2g",
  "2g"
].includes(Le.effectiveType) || Le.saveData), ge = /* @__PURE__ */ new WeakMap(), ke = (e, t) => $e.prototype.toString.call(e) === `[object ${t}]`;
let bo = 0;
const We = (e) => {
...
async function It(...e) {
  ...
  async function d(h) {
    ...
    const [v, f] = Ot(t, l), [k, c, F, ie] = W.get(t), P = () => {
      const A = k[l];
      return (M(a.revalidate) ? a.revalidate(v().data, h) : a.revalidate !== !1) && (delete F[l], delete ie[l], A && A[0]) ? A[0](Rt).then(() => v().data) : v().data;
    };
    if (e.length < 3)
      return P();
    let R = o, C;
...
const mt = (e, t) => {
  ...
  if (!W.has(e)) {
    const n = z(To, t), o = {}, i = It.bind(I, e);
    let a = U;
    const s = {}, u = (S, d) => {
      const h = s[S] || [];
      ...
      if (!W.has(e) && (W.set(e, [
        ...
        const S = n.initFocus(setTimeout.bind(I, mt.bind(I, o, bt))), d = n.initReconnect(setTimeout.bind(I, mt.bind(I, o, Et)));
        a = () => {
          S && S(), d && d(), W.delete(e);
        };
      }
...
}, Oo = Ae, [Lt, Io] = Ro(/* @__PURE__ */ new Map()), Lo = z(
  {
    // events
    onLoadingSlow: U,
    onSuccess: U,
  ...
  null,
  (e[1] === null ? e[2] : e[1]) || {}
], Vo = () => z(Lo, Ht(Co)), Mo = (e) => (t, n, o) => e(t, n && ((...a) => {
  const [s] = Ge(t), [, , , u] = W.get(Lt);
  if (s.startsWith(Do))
    return n(...a);
  const p = u[s];
...
((e) => {
  ...
  const { cache: o, compare: i, suspense: a, fallbackData: s, revalidateOnMount: u, revalidateIfStale: p, refreshInterval: _, refreshWhenHidden: S, refreshWhenOffline: d, keepPreviousData: h } = n, [l, v, f, k] = W.get(o), [c, F] = Ge(e), ie = X(!1), P = X(!1), R = X(c), C = X(t), J = X(n), x = () => J.current, Y = () => x().isVisible() && x().isOnline(), [$, Z, G, A] = Ot(o, c), ee = X({}).current, fe = m(s) ? m(n.fallback) ? I : n.fallback[c] : s, Ke = (w, y) => {
    for (const N in ee) {
      const T = N;
      if (T === "data") {
    ...
    async (w) => {
      ...
      if (!c || !y || P.current || x().isPaused())
        return !1;
      let N, T, V = !0;
      const re = w || {}, b = !f[c] || !re.dedupe, O = () => _t ? !P.current && c === R.current && ie.current : c === R.current, j = {
        isValidating: !1,
        isLoading: !1
      }, et = () => {
        Z(j);
      ...
      try {
        ...
        const B = $().data;
        j.data = i(B, N) ? B : N, b && O() && x().onSuccess(N, c, n);
      } catch (q) {
        tt();
  ...
  if (Ie(() => {
    ...
    return P.current = !1, R.current = c, ie.current = !0, Z({
      _k: F
    }), Je && (m(K) || le ? w() : xo(w)), () => {
      P.current = !0, T();
    };
...
function Qo(e) {
  ...
  return /* @__PURE__ */ r("div", { className: "border-neutral-200 richtext-rounded-lg !richtext-border richtext-bg-white richtext-p-2 richtext-shadow-sm dark:richtext-border-neutral-800 dark:richtext-bg-black", children: /* @__PURE__ */ g(
    "form",
    {
      ...
      onSubmit: i,
      children: [
        /* @__PURE__ */ r(Xt, { className: "mb-[6px]", children: t("editor.link.dialog.text") }),
...
function Jo(e) {
  ...
  return /* @__PURE__ */ g(Yt, { modal: !0, children: [
    /* @__PURE__ */ r(Zt, { disabled: e == null ? void 0 : e.disabled, asChild: !0, children: /* @__PURE__ */ r(
      Gt,
      {
        tooltip: e == null ? void 0 : e.tooltip,
        isActive: e == null ? void 0 : e.isActive,
        disabled: e == null ? void 0 : e.disabled,
        children: /* @__PURE__ */ r(tn, { name: e == null ? void 0 : e.icon })
      }
    ) }),
