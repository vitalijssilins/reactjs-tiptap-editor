...
var S = (t, e, o) => R(t, typeof e != "symbol" ? e + "" : e, o);
import { useSyncExternalStore as I, useMemo as P, useEffect as U } from "react";
const j = "en", M = 200, gt = M - 80, ct = 20, ht = 1e5, ft = 16, bt = 10, kt = 10, vt = 2, Tt = [
  "#000000",
  "#262626",
  "#595959",
  "#8C8C8C",
...
var K = /* @__PURE__ */ ((t) => (t[t["size-small"] = 200] = "size-small", t[t["size-medium"] = 500] = "size-medium", t["size-large"] = "100%", t))(K || {}), O = /* @__PURE__ */ ((t) => (t[t["size-small"] = 480] = "size-small", t[t["size-medium"] = 640] = "size-medium", t["size-large"] = "100%", t))(O || {});
const _t = ["100%", "115%", "150%", "200%", "250%", "300%"], zt = "1", Ft = [
  "bold",
  "italic",
  "underline",
  "strike",
...
var L;
(function(t) {
  t[t.None = 0] = "None", t[t.Mutable = 1] = "Mutable", t[t.Watching = 2] = "Watching", t[t.RecursedCheck = 4] = "RecursedCheck", t[t.Recursed = 8] = "Recursed", t[t.Dirty = 16] = "Dirty", t[t.Pending = 32] = "Pending";
})(L || (L = {}));
function V({ update: t, notify: e, unwatched: o }) {
  return {
    link: a,
    unlink: u,
    propagate: k,
  ...
  function f(i, r) {
    ...
    t: do {
      ...
      for (; n--; ) {
        const m = r.subs, F = m.nextSub !== void 0;
        if (F ? (i = d.value, d = d.prev) : i = m, l) {
          if (t(r)) {
            F && b(m), r = i.sub;
            continue;
          }
...
let _ = 0, v = 0, T = 0, h;
const g = [], { link: D, unlink: E, propagate: q, checkDirty: H, shallowPropagate: G } = V({
  update(t) {
    return t.depsTail !== void 0 ? $(t) : w(t);
  },
  notify(t) {
    var a;
    let e = T, o = e;
  ...
  unwatched(t) {
    t.flags & 1 ? t.depsTail !== void 0 && (t.depsTail = void 0, t.flags = 17, x(t)) : B.call(t);
  }
});
function z(t) {
  const e = h;
...
function J(t) {
  const e = t.flags;
  if (e & 16 || e & 32 && H(t.deps, t)) {
    ++_, t.depsTail = void 0, t.flags = 6;
    const o = z(t);
    try {
      t.fn();
    } finally {
...
const C = new pt(), W = et(c.lang);
function At() {
  const [t, e] = ot(W), o = P(() => C.buildLocalesHandler(t), [t]);
  return U(() => {
    const a = C.registerWatchLang((u) => {
      e(u);
    });
    return () => {
      a.unsubscribe();
...
const St = {
  t: (t, e) => C.buildLocalesHandler(W())(t, e)
};
export {
  Ft as B,
  Tt as C,
