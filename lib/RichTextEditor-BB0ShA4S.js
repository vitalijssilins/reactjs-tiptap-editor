...
function Uu(e, t, r, n, i, o) {
  ...
  for (o.set(e, t), o.set(t, e); ++f < s; ) {
    var g = e[f], v = t[f];
    if (n)
      var m = a ? n(v, g, f, t, e, o) : n(g, v, f, e, t, o);
    if (m !== void 0) {
      if (m)
        continue;
      h = !1;
...
function g1(e, t, r, n, i, o) {
  ...
  if (!(r & p1)) {
    var p = d && Js.call(e, "__wrapped__"), g = f && Js.call(t, "__wrapped__");
    if (p || g) {
      var v = p ? e.value() : e, m = g ? t.value() : t;
      return o || (o = new nt()), i(v, m, r, n, o);
    }
  }
...
const za = "-", sv = (e) => {
  ...
  const {
    ...
    for (let m = 0; m < s.length; m++) {
      let y = s[m];
      if (u === 0) {
        if (y === i && (n || s.slice(m, m + o) === t)) {
          c.push(s.slice(d, m)), d = m + o;
          continue;
        }
        if (y === "/") {
          f = m;
    ...
    const h = c.length === 0 ? s : s.substring(d), p = h.startsWith(td), g = p ? h.substring(1) : h, v = f && f > d ? f - d : void 0;
    return {
      modifiers: c,
  ...
  for (let c = a.length - 1; c >= 0; c -= 1) {
    ...
    const m = pv(d).join(":"), y = f ? m + td : m, w = y + v;
    if (o.includes(w))
      continue;
    o.push(w);
    const A = i(v, g);
...
const ce = (e) => {
  ...
  const e = ce("colors"), t = ce("spacing"), r = ce("blur"), n = ce("brightness"), i = ce("borderColor"), o = ce("borderRadius"), a = ce("borderSpacing"), s = ce("borderWidth"), c = ce("contrast"), u = ce("grayscale"), d = ce("hueRotate"), f = ce("invert"), h = ce("gap"), p = ce("gradientColorStops"), g = ce("gradientColorStopPositions"), v = ce("inset"), m = ce("margin"), y = ce("opacity"), w = ce("padding"), A = ce("saturate"), I = ce("scale"), T = ce("sepia"), M = ce("skew"), L = ce("space"), k = ce("translate"), N = () => ["auto", "contain", "none"], $ = () => ["auto", "hidden", "clip", "visible", "scroll"], C = () => ["auto", V, t], S = () => [V, t], P = () => ["", Qe, mt], D = () => ["auto", qt, V], H = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], j = () => ["solid", "dashed", "dotted", "double", "none"], W = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], Q = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], te = () => ["", "0", V], ye = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], me = () => [qt, V];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
    ...
    return /* @__PURE__ */ E(Bd, { children: [
      /* @__PURE__ */ l(jd, { asChild: !0, children: /* @__PURE__ */ E(
        h ? fu : Dd,
        {
          ...
          ...v,
          children: [
            m && /* @__PURE__ */ l(m, { className: "richtext-size-4" }),
            f
          ]
        }
      ) }),
...
function ty(e, t) {
  ...
  const i = e.clientX, o = function(d, f, h) {
    const p = Number.parseInt(Br(d.dom, "paddingLeft"), 10), g = Number.parseInt(Br(d.dom, "paddingRight"), 10), v = Number.parseInt(Br(d.dom, "borderLeftWidth"), 10), m = Number.parseInt(Br(d.dom, "borderLeftWidth"), 10), y = d.dom.getBoundingClientRect();
    return {
      left: ey(
        f,
        y.left + p + v,
...
function ry({
  ...
  return t.addEventListener("dragstart", (d) => {
    ...
    const { empty: h, $from: p, $to: g } = f.state.selection, v = ty(d, r), m = Ha(p, g, 0), y = m.some((N) => v.find(($) => $.$from === N.$from && $.$to === N.$to)), w = h || !y ? v : m;
      ...
      handleDOMEvents: {
        ...
        mousemove: Dn((d, f) => {
          ...
          if (p === d.dom || (p == null ? void 0 : p.nodeType) !== 1)
            return !1;
          const g = d.posAtDOM(p, 0), v = ic(r.state.doc, g);
          if (v === c)
            return !1;
          const m = nc(r.state.doc, g);
          return c = v, u = m, i == null || i({
            editor: r,
            node: c,
            pos: u
          }), a.setProps({
...
function Ly({ editor: e, disabled: t, actions: r }) {
  var m, y, w, A, I, T, M, L, k, N, $, C, S, P, D, H, j, W;
    ...
    St,
    {
      ...
      children: t ? /* @__PURE__ */ l(de, {}) : /* @__PURE__ */ E("div", { className: "richtext-flex richtext-size-full richtext-min-w-32 richtext-flex-row richtext-items-center richtext-gap-0.5 richtext-rounded-lg !richtext-border richtext-border-border richtext-bg-background richtext-p-2 richtext-leading-none richtext-shadow-sm", children: [
        /* @__PURE__ */ l(
          ...
          {
            action: o,
            disabled: !((y = (m = e == null ? void 0 : e.can()) == null ? void 0 : m.addColumnBefore) != null && y.call(m)),
...
function Fy(e = []) {
  ...
  const h = O(f, qy);
  O(h, "#"), he(h, di, f);
  const p = [[et, a], [tt, i]], g = [[et, null], [rr, s], [tt, o]];
  ...
  Et(Aa, {
    ...
    slashscheme: !0,
    ascii: !0
  }, t), e = e.sort((v, m) => v[0] > m[0] ? 1 : -1);
  for (let v = 0; v < e.length; v++) {
    const m = e[v][0], w = e[v][1] ? {
      [Dy]: !0
    } : {
      [By]: !0
    };
    m.indexOf("-") >= 0 ? w[wa] = !0 : et.test(m) ? tt.test(m) ? w[sr] = !0 : w[xa] = !0 : w[ya] = !0, ac(r, m, m, w);
  }
...
function Gy({
  ...
  const g = O(f, Le);
  O(g, Le, g), Y(g, e.domain, f), Y(p, e.domain, f), O(p, qe, h), O(p, Le, g);
  const v = O(p, bt);
  Y(v, e.numeric, uc);
  const m = O(a, Le), y = O(a, qe);
  O(m, Le, m), Y(m, e.domain, a), Y(y, n, o), Y(y, e.domain, a);
  const w = Me(Hr);
  Y(y, e.tld, w), Y(y, e.utld, w), Y(w, e.domain, a), Y(w, n, o), O(w, qe, y), O(w, Le, m), O(w, xt, u);
  const A = O(w, bt), I = Me(Hr);
  Y(A, e.numeric, I);
  const T = Me(Hr), M = Me();
  Y(T, t, T), Y(T, r, M), Y(M, t, T), Y(M, r, M), O(w, Fe, T), O(I, Fe, T);
  const L = O(s, bt), k = O(c, bt), N = O(k, Fe), $ = O(N, Fe);
  Y(s, e.domain, a), O(s, qe, y), O(s, Le, m), Y(c, e.domain, a), O(c, qe, y), O(c, Le, m), Y(L, e.domain, T), O(L, Fe, T), O(L, dr, T), Y($, e.domain, T), Y($, t, T), O($, Fe, T);
  const C = [
    [cr, lr],
    // {}
    [nn, on],
    ...
    appendTransaction: (t, r, n) => {
      ...
      if (hp(s).forEach(({ newRange: u }) => {
        ...
        if (d.length > 1 ? (f = d[0], h = n.doc.textBetween(f.pos, f.pos + f.node.nodeSize, void 0, " ")) : d.length && n.doc.textBetween(u.from, u.to, " ", " ").endsWith(" ") && (f = d[0], h = n.doc.textBetween(f.pos, u.to, void 0, " ")), f && h) {
          ...
          if (p.length <= 0)
            return !1;
          const g = p[p.length - 1], v = f.pos + h.lastIndexOf(g);
          if (!g)
            return !1;
          const m = Ja(g).map((y) => y.toObject(e.defaultProtocol));
          if (!Zy(m))
            return !1;
  ...
  pe(() => {
    const s = () => {
      ...
      if ((c = e.editor) != null && c.isActive("link")) {
        const { href: f, target: h } = e.editor.getAttributes("link"), { from: p, to: g } = e.editor.state.selection, v = e.editor.state.doc.textBetween(p, g, " ");
...
function sx({ editor: e, disabled: t }) {
  const [r, n] = J(!1), i = we(() => {
    ...
    return c;
  }, [e]), o = oe(({ editor: c }) => c.isActive("link"), []), a = (c, u, d) => {
    const f = e.state.selection, { from: h } = f, p = (u == null ? void 0 : u.length) ?? 0, g = h + p;
    ...
    }).setLink({ href: c }).setTextSelection({ from: h, to: g }).focus().run(), n(!1);
  }, s = oe(() => {
  ...
  return /* @__PURE__ */ l(de, { children: /* @__PURE__ */ l(
    St,
    {
      ...
      children: t ? /* @__PURE__ */ l(de, {}) : /* @__PURE__ */ l(de, { children: r ? /* @__PURE__ */ l(vd, { onSetLink: a, editor: e }) : /* @__PURE__ */ l(
        ax,
        {
          editor: e,
          onClear: s,
...
function mx({ editor: e, imageInline: t, onClose: r, disabled: n, alt: i }) {
  var $, C;
  const { t: o } = Se(), { toast: a } = is(), [s, c] = J(!1), [u, d] = J(!1), f = ir.useRef(null), [h, p] = ir.useState(), [g, v] = ir.useState(""), m = ot(null), [y, w] = J({
    src: "",
    file: null
  }), A = we(() => {
    var S;
  ...
  const M = ir.useCallback(async () => {
    ...
    if (!u) {
      d(!0);
      try {
        const P = hx(g, ((S = y == null ? void 0 : y.file) == null ? void 0 : S.name) || "image.png");
        let D = "";
  ...
  }, [g, e, t, u, r, ($ = y == null ? void 0 : y.file) == null ? void 0 : $.name, A]);
  function L(S) {
    var P;
    S.preventDefault(), (P = m.current) == null || P.click();
  }
  const k = async (S) => {
    var W;
...
function xx(e) {
  ...
  const { t } = Se(), { toast: r } = is(), [n, i] = J(!1), [o, a] = J(!1), s = (T) => {
    ...
    (T) => T.name === wr.name
  )) == null ? void 0 : I.options.defaultInline) || !1, [g, v] = J(p), m = we(() => {
    var M;
    ...
    try {
      if (m != null && m.multiple) {
        const N = L.map(async (C) => {
          let S = "";
          return m.upload ? S = await m.upload(C) : S = URL.createObjectURL(C), S;
        });
        (await Promise.all(N)).forEach((C) => {
          e.editor.chain().focus().setImageInline({ src: C, inline: g, alt: d }).run();
        });
      } else {
        const N = L[0];
        let $ = "";
        m.upload ? $ = await m.upload(N) : $ = URL.createObjectURL(N), e.editor.chain().focus().setImageInline({ src: $, inline: g, alt: d }).run();
      }
      i(!1), f(""), v(p);
    } catch (N) {
      console.error("Error uploading image", N), m.onError ? m.onError({
        type: "upload",
  ...
  function w(T) {
    T.preventDefault(), T.stopPropagation(), e.editor.chain().focus().setImageInline({ src: c, inline: g, alt: d }).run(), i(!1), v(p), u(""), f("");
  }
  function A(T) {
    var M;
            ...
            Nd,
            {
              ...
              children: [
                /* @__PURE__ */ E(rs, { className: "richtext-grid richtext-w-full richtext-grid-cols-2", children: [
                  m.resourceImage === "both" || m.resourceImage === "upload" ? /* @__PURE__ */ l(Sr, { value: "upload", children: t("editor.image.dialog.tab.upload") }) : /* @__PURE__ */ l(de, {}),
                  m.resourceImage === "both" || m.resourceImage === "link" ? /* @__PURE__ */ l(Sr, { value: "link", children: t("editor.image.dialog.tab.url") }) : /* @__PURE__ */ l(de, {})
                ] }),
                ...
                m.enableAlt && /* @__PURE__ */ E("div", { className: "richtext-my-[10px] ", children: [
...
function bx(e) {
  ...
  }, [(N = e == null ? void 0 : e.node) == null ? void 0 : N.attrs]), g = we(() => {
    const {
      style: { width: C }
    } = p;
    ...
    for (const s of i) {
      ...
      u.setMeta(Ft, {
        ...
        async (f) => {
          ...
          if (p === null)
            return;
          const g = typeof f == "object" ? d : f, v = (w = h.nodes.image) == null ? void 0 : w.create({
            src: g,
            inline: n
          });
          if (!v)
            return;
          const { doc: m } = o.state;
          p > m.content.size && (p = m.content.size - 1);
...
function kx(e) {
  const { t } = Se(), [r, n] = J(""), i = ot(null), [o, a] = J(""), [s, c] = J(!1), u = (g) => {
    c(g.detail);
  };
  pe(() => {
    const g = Pn(Rt.UPLOAD_VIDEO(e.editor.id), u);
    return () => {
      g();
    };
  }, []);
  ...
  async function f(g) {
    var w;
    const v = (w = g == null ? void 0 : g.target) == null ? void 0 : w.files;
    if (!e.editor || e.editor.isDestroyed || v.length === 0)
      return;
    const m = v[0];
    let y = "";
    d.upload ? y = await d.upload(m) : y = URL.createObjectURL(m), e.editor.chain().focus().setVideo({
      src: y,
      width: "100%"
    }).run(), c(!1);
  }
  function h(g) {
    g.preventDefault(), g.stopPropagation(), r && (e.editor.chain().focus().setVideo({
      src: r,
      width: "100%"
    }).run(), c(!1));
  }
  function p(g) {
    var v;
    g.preventDefault(), (v = i.current) == null || v.click();
  }
  return /* @__PURE__ */ E(
    jn,
    {
                  ...
                  /* @__PURE__ */ l("form", { onSubmit: h, children: /* @__PURE__ */ E("div", { className: "richtext-flex richtext-items-center richtext-gap-2", children: [
                    /* @__PURE__ */ l(
                      Ne,
                      {
                        ...
                        onBlur: (g) => {
                          const v = g.target.value, m = d.videoProviders || ["."];
                          v && !Nx(v, m) ? a("Invalid video URL") : a("");
                        }
                      }
                    ),
  ...
  return /* @__PURE__ */ E(Pa, { children: [
    ...
    i && /* @__PURE__ */ l(
      Sp,
      {
        ...
        onResizeStop: (f, h, p, g) => {
          d({
            width: Number.parseInt(o) + g.width,
            height: Number.parseInt(a) + g.height
          });
        },
...
function Bb() {
  ...
  if (!Object.keys) {
    ...
    e = function(p) {
      var g = p !== null && typeof p == "object", v = r.call(p) === "[object Function]", m = n(p), y = g && r.call(p) === "[object String]", w = [];
      if (!g && !v && !m)
...
function Zb() {
  ...
  return Yi = function(c) {
    ...
    }, p = r(0, u.length - d.length), g = [], v = 0; v < p; v++)
      g[v] = "$" + v;
    if (f = Function("binder", "return function (" + a(g, ",") + "){ return binder.apply(this,arguments); }")(h), u.prototype) {
      var m = function() {
      };
...
function ut() {
  if (al) return oo;
  al = 1;
  var e, t = /* @__PURE__ */ ls(), r = /* @__PURE__ */ Fd(), n = /* @__PURE__ */ zb(), i = /* @__PURE__ */ Hb(), o = /* @__PURE__ */ qb(), a = /* @__PURE__ */ as(), s = /* @__PURE__ */ _e(), c = /* @__PURE__ */ Fb(), u = /* @__PURE__ */ Ub(), d = /* @__PURE__ */ Wb(), f = /* @__PURE__ */ Gb(), h = /* @__PURE__ */ Vb(), p = /* @__PURE__ */ Kb(), g = /* @__PURE__ */ Yb(), v = /* @__PURE__ */ Jb(), m = Function, y = function(re) {
    try {
      return m('"use strict"; return (' + re + ").constructor;")();
    } catch {
    }
...
function Kd() {
  ...
  return lo = function(c, u) {
    ...
    for (var f = 1; f < arguments.length; ++f) {
      var h = n(arguments[f]), p = e(h), g = t && (n.getOwnPropertySymbols || a);
      if (g)
        for (var v = g(h), m = 0; m < v.length; ++m) {
          var y = v[m];
          o(h, y) && i(p, y);
        }
...
function Wn() {
  ...
  function Ye(x) {
    if (x.name)
      return x.name;
    var b = y.call(m.call(x), /^function\s*([\w$]+)/);
    return b ? b[1] : null;
  }
  function je(x, b) {
    if (x.indexOf)
  ...
  return Eo = o ? (
    ...
    function() {
      var f, h, p = {
        ...
        get: function(g) {
          return o && g && (typeof g == "object" || typeof g == "function") && f ? a(f, g) : h && h.get(g);
        },
        has: function(g) {
          return o && g && (typeof g == "object" || typeof g == "function") && f ? c(f, g) : !!h && h.has(g);
        },
        set: function(g, v) {
          o && g && (typeof g == "object" || typeof g == "function") ? (f || (f = new o()), s(f, g, v)) : n && (h || (h = n()), h.set(g, v));
        }
      };
      return p;
    }
...
function g2() {
  ...
  if (us()() || Un()()) {
    ...
    if (!a && !s)
      ...
      var v = /* @__PURE__ */ of(), m = /* @__PURE__ */ af(), y = c("Map.prototype.forEach", !0), w = c("Set.prototype.forEach", !0);
...
function N2() {
  ...
  }, s = Object.prototype.toString, c = "[object Object]", u = "[object Function]", d = "[object GeneratorFunction]", f = "[object HTMLAllCollection]", h = "[object HTML document.all class]", p = "[object HTMLCollection]", g = typeof Symbol == "function" && !!Symbol.toStringTag, v = !(0 in [,]), m = function() {
    return !1;
  };
  if (typeof document == "object") {
    var y = document.all;
    s.call(y) === s.call(document.all) && (m = function(A) {
...
function $2() {
  if (iu) return Qo;
  iu = 1;
  var e = k2(), t = /* @__PURE__ */ L2(), r = Xt(), n = /* @__PURE__ */ Ee(), i = /* @__PURE__ */ Mt(), o = n("Object.prototype.toString"), a = $t()(), s = typeof globalThis > "u" ? kn : globalThis, c = t(), u = n("String.prototype.slice"), d = Object.getPrototypeOf, f = n("Array.prototype.indexOf", !0) || function(m, y) {
  ...
  a && i && d ? e(c, function(v) {
    ...
    if (Symbol.toStringTag in m) {
      var y = d(m), w = i(y, Symbol.toStringTag);
      if (!w) {
        var A = d(y);
  ...
  return Qo = function(m) {
    if (!m || typeof m != "object")
      return !1;
    if (!a) {
      var y = u(o(m), 8, -1);
      return f(c, y) > -1 ? y : y !== "Object" ? !1 : g(m);
    }
    return i ? p(m) : null;
  }, Qo;
}
...
function q2({ editor: e }) {
  ...
  const d = oe(() => {
    ...
    (m) => {
      e.chain().updateAttributes(zt.name, m).setNodeSelection(e.state.selection.from).focus().run();
    },
    [e]
  ), g = oe(() => e.isActive(zt.name) && !i, [e, i]), v = oe(() => Id(zt.name, e), [e]);
  return /* @__PURE__ */ E(de, { children: [
    /* @__PURE__ */ l(
      St,
      {
    ...
    return [
      ...
      (p = r == null ? void 0 : r.floatingMenuConfig) != null && p.hidden ? null : /* @__PURE__ */ l(
        oy,
        {
          disabled: t,
          editor: e,
          hidePlusIcon: (g = r == null ? void 0 : r.floatingMenuConfig) == null ? void 0 : g.hidePlusIcon
        },
        "content"
      ),
...
function U2(e) {
  const { t } = Se(), {
    ...
    for (let v = 0; v < p.length; v += 10)
      g.push(p.slice(v, v + 10));
    return g;
  }, [s]), [u, d] = J([]), f = (p) => {
    const g = [...u], v = g.indexOf(p);
    v !== -1 && g.splice(v, 1), g.unshift(p), g.length > 10 && g.pop(), d(g);
  };
  function h(p) {
    if (p === void 0) {
      ...
      Kt,
      {
        ...
        children: /* @__PURE__ */ E("div", { className: "richtext-flex richtext-flex-col", children: [
          ...
          /* @__PURE__ */ E("div", { children: [
            ...
            /* @__PURE__ */ l("span", { className: "richtext-relative richtext-flex richtext-h-auto richtext-w-full richtext-p-0 last:richtext-pb-2", children: u == null ? void 0 : u.map((p, g) => /* @__PURE__ */ l(
              "span",
              {
                className: "richtext-inline-block richtext-size-6 richtext-flex-[0_0_auto] richtext-cursor-pointer richtext-rounded-sm !richtext-border richtext-border-transparent richtext-p-0.5 hover:richtext-border-border hover:richtext-shadow-sm",
                onClick: () => h(p),
...
function G2({ editor: e, disabled: t, toolbar: r }) {
  const { t: n, lang: i } = Se(), o = we(() => {
    const u = [...e.extensionManager.extensions].sort((f, h) => {
      const p = f.options.sort ?? -1, g = h.options.sort ?? -1;
      return p - g;
    });
    let d = [];
    for (const f of u) {
...
function nw(e, t) {
  const { content: r, extensions: n, useEditorOptions: i = {}, renderToolbar: o, renderHeader: a } = e, s = If(), c = we(() => {
    ...
    var y;
    const m = f(v, e.output);
    (y = e == null ? void 0 : e.onChangeContent) == null || y.call(e, m);
  }, $f), d = Pf({
    extensions: c,
    content: r,
  ...
  function f(v, m) {
    return e != null && e.removeDefaultWrapper ? m === "html" ? v.isEmpty ? "" : v.getHTML() : m === "json" ? v.isEmpty ? {} : v.getJSON() : m === "text" ? v.isEmpty ? "" : v.getText() : "" : m === "html" ? v.getHTML() : m === "json" ? v.getJSON() : m === "text" ? v.getText() : "";
  }
  Of(() => {
    d && (d.id = s);
  }, [s, d]), pe(() => () => {
  ...
  return o && p ? /* @__PURE__ */ E("div", { className: "reactjs-tiptap-editor", children: [
    /* @__PURE__ */ l(lu, { id: s, children: /* @__PURE__ */ E(yc, { delayDuration: 0, disableHoverableContent: !0, children: [
      o(p),
      /* @__PURE__ */ l("div", { className: "richtext-overflow-hidden richtext-rounded-[0.5rem] richtext-bg-background richtext-shadow richtext-outline richtext-outline-1", children: /* @__PURE__ */ l("div", { className: "richtext-flex richtext-max-h-full richtext-w-full richtext-flex-col", children: g }) })
    ] }) }),
    /* @__PURE__ */ l(cu, {})
